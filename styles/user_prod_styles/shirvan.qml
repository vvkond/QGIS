...
<qgis version="2.18.24" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias field="startdate" index="10" name=""/>
    <alias field="days" index="11" name=""/>
    <alias field="liftmethod" index="12" name=""/>
    <alias field="lablx" index="13" name=""/>
    <alias field="lably" index="14" name=""/>
    <alias field="labloffx" index="15" name=""/>
    <alias field="labloffy" index="16" name=""/>
    <alias field="labloffset" index="17" name=""/>
    <alias field="lablwidth" index="18" name=""/>
    <alias field="bubblesize" index="19" name=""/>
    <alias field="scaletype" index="20" name=""/>
    <alias field="movingres" index="21" name=""/>
    <alias field="resstate" index="22" name=""/>
    <alias field="multiprod" index="23" name=""/>
    <alias field="oilvol" index="24" name="Сырая нефть (объем)"/>
    <alias field="oilmas" index="25" name="Сырая нефть (масса)"/>
    <alias field="oilmax_m" index="26" name="Сырая нефть (макс. дебит по массе)"/>
    <alias field="oilmaxd_m" index="27" name="Сырая нефть (дата макс. дебита по массе)"/>
    <alias field="oilmax_v" index="28" name="Сырая нефть (макс. дебит по объему)"/>
    <alias field="oilmaxd_v" index="29" name="Сырая нефть (дата макс. дебита по объему)"/>
    <alias field="ngasvol" index="30" name="Природный газ (объем)"/>
    <alias field="ngasmas" index="31" name="Природный газ (масса)"/>
    <alias field="ngasmax_m" index="32" name="Природный газ (макс. дебит по массе)"/>
    <alias field="ngasmaxd_m" index="33" name="Природный газ (дата макс. дебита по массе)"/>
    <alias field="ngasmax_v" index="34" name="Природный газ (макс. дебит по объему)"/>
    <alias field="ngasmaxd_v" index="35" name="Природный газ (дата макс. дебита по объему)"/>
    <alias field="pwvol" index="36" name="Добыча вода (объем)"/>
    <alias field="pwmas" index="37" name="Добыча вода (масса)"/>
    <alias field="pwmax_m" index="38" name="Добыча вода (макс. дебит по массе)"/>
    <alias field="pwmaxd_m" index="39" name="Добыча вода (дата макс. дебита по массе)"/>
    <alias field="pwmax_v" index="40" name="Добыча вода (макс. дебит по объему)"/>
    <alias field="pwmaxd_v" index="41" name="Добыча вода (дата макс. дебита по объему)"/>
    <alias field="condvol" index="42" name="Конденсат (объем)"/>
    <alias field="condmas" index="43" name="Конденсат (масса)"/>
    <alias field="condmax_m" index="44" name="Конденсат (макс. дебит по массе)"/>
    <alias field="condmaxd_m" index="45" name="Конденсат (дата макс. дебита по массе)"/>
    <alias field="condmax_v" index="46" name="Конденсат (макс. дебит по объему)"/>
    <alias field="condmaxd_v" index="47" name="Конденсат (дата макс. дебита по объему)"/>
    <alias field="igasvol" index="48" name="Закачка газа (объем)"/>
    <alias field="igasmas" index="49" name="Закачка газа (масса)"/>
    <alias field="igasmax_m" index="50" name="Закачка газа (макс. дебит по массе)"/>
    <alias field="igasmaxd_m" index="51" name="Закачка газа (дата макс. дебита по массе)"/>
    <alias field="igasmax_v" index="52" name="Закачка газа (макс. дебит по объему)"/>
    <alias field="igasmaxd_v" index="53" name="Закачка газа (дата макс. дебита по объему)"/>
    <alias field="iwvol" index="54" name="Закачка воды (объем)"/>
    <alias field="iwmas" index="55" name="Закачка воды (масса)"/>
    <alias field="iwmax_m" index="56" name="Закачка воды (макс. дебит по массе)"/>
    <alias field="iwmaxd_m" index="57" name="Закачка воды (дата макс. дебита по массе)"/>
    <alias field="iwmax_v" index="58" name="Закачка воды (макс. дебит по объему)"/>
    <alias field="iwmaxd_v" index="59" name="Закачка воды (дата макс. дебита по объему)"/>
    <alias field="lgasvol" index="60" name="Газлифт (объем)"/>
    <alias field="lgasmas" index="61" name="Газлифт (масса)"/>
    <alias field="lgasmax_m" index="62" name="Газлифт (макс. дебит по массе)"/>
    <alias field="lgasmaxd_m" index="63" name="Газлифт (дата макс. дебита по массе)"/>
    <alias field="lgasmax_v" index="64" name="Газлифт (макс. дебит по объему)"/>
    <alias field="lgasmaxd_v" index="65" name="Газлифт (дата макс. дебита по объему)"/>
    <alias field="fgasvol" index="66" name="Свободный газ (объем)"/>
    <alias field="fgasmas" index="67" name="Свободный газ (масса)"/>
    <alias field="fgasmax_m" index="68" name="Свободный газ (макс. дебит по массе)"/>
    <alias field="fgasmaxd_m" index="69" name="Свободный газ (дата макс. дебита по массе)"/>
    <alias field="fgasmax_v" index="70" name="Свободный газ (макс. дебит по объему)"/>
    <alias field="fgasmaxd_v" index="71" name="Свободный газ (дата макс. дебита по объему)"/>
    <alias field="pflvol" index="72" name="Добыча жидкости (объем)"/>
    <alias field="pflmas" index="73" name="Добыча жидкости (масса)"/>
    <alias field="pflmax_m" index="74" name="Добыча жидкости (макс. дебит по массе)"/>
