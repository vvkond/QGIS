...
<qgis version="2.18.28" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="1">
    <rules key="{9966bf9d-607b-4a3d-b03f-d4e6ad6e0a70}">
      <rule filter=" (&quot;transite&quot;  is not None or  &quot;symbolid&quot; &lt;>71) &#xd;&#xa; and  &#xd;&#xa; (&quot;days&quot; >0 &#xd;&#xa;&#x9;or &quot;symbolcode&quot; in &#xd;&#xa;&#x9;(&#xd;&#xa;&#x9; 89+1  ---&quot;piezometr&quot;, &quot;piezometric stock&quot;&#xd;&#xa;&#x9;,181+1 ---&quot;oil producing&quot;, &quot;abandonment stock&quot;&#xd;&#xa;&#x9;,185+1 ---&quot;water injecting&quot;, &quot;abandonment stock&quot;&#xd;&#xa;&#x9;,225+1 ---&quot;gas producing&quot;, &quot;abandonment stock&quot;&#xd;&#xa;&#x9;,234+1 ---&quot;water-supply&quot;, &quot;abandonment stock&quot;&#xd;&#xa;&#x9;,243+1 ---&quot;water absorbing&quot;, &quot;abandonment stock&quot;&#xd;&#xa;&#x9;,181+1 ---&quot;oil producing&quot;, &quot;waiting abandonment stock&quot;&#xd;&#xa;&#x9;,185+1 ---&quot;water injecting&quot;, &quot;waiting abandonment stock&quot;&#xd;&#xa;&#x9;,225+1 ---&quot;gas producing&quot;, &quot;waiting abandonment stock&quot;&#xd;&#xa;&#x9;,235+1 ---&quot;water-supply&quot;, &quot;waiting abandonment stock&quot;&#xd;&#xa;&#x9;,244+1 ---&quot;water absorbing&quot;, &quot;waiting abandonment stock&quot;&#xd;&#xa;&#x9;,188+1 ---&quot;oil producing&quot;, &quot;exploration abandonment stock&quot;&#xd;&#xa;&#x9;,188+1 ---&quot;water injecting&quot;, &quot;exploration abandonment stock&quot;&#xd;&#xa;&#x9;,188+1 ---&quot;gas producing&quot;, &quot;exploration abandonment stock&quot;&#xd;&#xa;&#x9;,188+1 ---&quot;water-supply&quot;, &quot;exploration abandonment stock&quot;&#xd;&#xa;&#x9;,188+1 ---&quot;water absorbing&quot;, &quot;exploration abandonment stock&quot;&#xd;&#xa;&#x9;) &#xd;&#xa;&#x9;or  &quot;wellstatus&quot;  in&#xd;&#xa;&#x9;(&#xd;&#xa;&#x9; 'abandonment stock' &#xd;&#xa;&#x9;)&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;)" key="{f970b71f-f6d7-4eb4-ae26-32d72372d2e5}" label="добуренные">
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="2" class="BubbleDiagramm" locked="0">
          <prop k="diagrammStr" v="[{'scaleMaxRadius': 20.0, 'scaleMinRadius': 1.0, 'scale': 943395.0, 'slices': [{'labelColor': u'#b22222', 'expression': u'oilmas', 'inPercent': 0, 'lineColor': u'253,191,111,255', 'backColor': u'253,191,111,255'}, {'labelColor': u'#000000', 'expression': u'pwmas', 'inPercent': 0, 'lineColor': u'204,204,204,255', 'backColor': u'204,204,204,255'}], 'fixedSize': 20.0, 'multiplier': 0.001, 'decimals': 2, 'dailyProduction': True, 'scaleType': 1}, {'scaleMaxRadius': 20.0, 'scaleMinRadius': 1.0, 'scale': 943.395, 'slices': [{'labelColor': u'#0000ff', 'expression': u'iwvol', 'inPercent': 0, 'lineColor': u'0,255,255,255', 'backColor': u'0,255,255,255'}], 'fixedSize': 20.0, 'multiplier': 1.0, 'decimals': 2, 'dailyProduction': True, 'scaleType': 1}]"/>
          <prop k="labelSize" v="9.0"/>
          <prop k="showDiagramms" v="False"/>
          <prop k="showLabels" v="False"/>
          <prop k="showLineouts" v="True"/>
          <prop k="templateStr" v="&quot;oilmas&quot;-&quot;pwmas&quot;-&quot;iwvol&quot;"/>
        </layer>
      </symbol>
  ...
  <customproperties>
    ...
    <property key="fluid_label_color_iw" value="0,0,255,255"/>
  ...
  <aliases>
    <alias field="well_id" index="0" name="Скважина"/>
    <alias field="latitude" index="1" name="Широта"/>
    <alias field="longitude" index="2" name="Долгота"/>
    ...
    <alias field="startdate" index="11" name="дата начала"/>
    <alias field="days" index="12" name="Кол-во дней работы"/>
    <alias field="liftmethod" index="13" name="способ эксплуатации"/>
    ...
    <alias field="oilmax_m" index="31" name="Сырая нефть (макс. дебит по массе тонн)"/>
    <alias field="oilmaxd_m" index="32" name="Сырая нефть (дата макс. дебита по массе)"/>
    <alias field="oilmax_v" index="33" name="Сырая нефть (макс. дебит по объему м3)"/>
    ...
    <alias field="ngasmax_m" index="37" name="Природный газ (макс. дебит по массе тонн)"/>
    <alias field="ngasmaxd_m" index="38" name="Природный газ (дата макс. дебита по массе)"/>
    <alias field="ngasmax_v" index="39" name="Природный газ (макс. дебит по объему м3)"/>
    ...
    <alias field="pwmax_m" index="43" name="Добыча вода (макс. дебит по массе тонн)"/>
    <alias field="pwmaxd_m" index="44" name="Добыча вода (дата макс. дебита по массе)"/>
    <alias field="pwmax_v" index="45" name="Добыча вода (макс. дебит по объему м3)"/>
    ...
    <alias field="condmax_m" index="49" name="Конденсат (макс. дебит по массе тонн)"/>
    <alias field="condmaxd_m" index="50" name="Конденсат (дата макс. дебита по массе)"/>
    <alias field="condmax_v" index="51" name="Конденсат (макс. дебит по объему м3)"/>
    ...
    <alias field="igasmax_m" index="55" name="Закачка газа (макс. дебит по массе тонн)"/>
    <alias field="igasmaxd_m" index="56" name="Закачка газа (дата макс. дебита по массе)"/>
    <alias field="igasmax_v" index="57" name="Закачка газа (макс. дебит по объему м3)"/>
    ...
    <alias field="iwmax_m" index="61" name="Закачка воды (макс. дебит по массе тонн)"/>
    <alias field="iwmaxd_m" index="62" name="Закачка воды (дата макс. дебита по массе)"/>
    <alias field="iwmax_v" index="63" name="Закачка воды (макс. дебит по объему м3)"/>
    ...
    <alias field="lgasmax_m" index="67" name="Газлифт (макс. дебит по массе тонн)"/>
    <alias field="lgasmaxd_m" index="68" name="Газлифт (дата макс. дебита по массе)"/>
    <alias field="lgasmax_v" index="69" name="Газлифт (макс. дебит по объему м3)"/>
    ...
    <alias field="fgasmax_m" index="73" name="Свободный газ (макс. дебит по массе тонн)"/>
    <alias field="fgasmaxd_m" index="74" name="Свободный газ (дата макс. дебита по массе)"/>
    <alias field="fgasmax_v" index="75" name="Свободный газ (макс. дебит по объему м3)"/>
    ...
    <alias field="pflmax_m" index="79" name="Добыча жидкости (макс. дебит по массе тонн)"/>
    <alias field="pflmaxd_m" index="80" name="Добыча жидкости (дата макс. дебита по массе)"/>
    <alias field="pflmax_v" index="81" name="Добыча жидкости (макс. дебит по объему м3)"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="wellrole"/>
      <column width="-1" hidden="0" type="field" name="wellstatus"/>
