--- READ WELLS, THAT WORK ON SELECTED DATE/RESERVOIRS/CONDUIT
...
FROM
        ...
        ---- ##### WELLS INFO FROM TIG_WELL_HISTORY
        INNER JOIN TIG_WELL_HISTORY twh
            ON twh.TIG_LATEST_WELL_NAME=WELL_ID
		    AND (NOT twh.TIG_LONGITUDE = 0  AND NOT twh.TIG_LATITUDE = 0)
...
order by twh.TIG_LATEST_WELL_NAME
