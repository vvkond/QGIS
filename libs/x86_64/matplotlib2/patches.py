...
class Patch(artist.Artist):
    ...
    def get_extents(self):
        """
        Return a :class:`~matplotlib2.transforms.Bbox` object defining
    ...
    def get_transform(self):
        """
        Return the :class:`~matplotlib2.transforms.Transform` applied
        to the :class:`Patch`.
        """
    ...
    def get_data_transform(self):
        """
        Return the :class:`~matplotlib2.transforms.Transform` instance which
    ...
    def set_color(self, c):
        ...
        ACCEPTS: matplotlib2 color spec
...
class PathPatch(Patch):
    ...
    def __init__(self, path, **kwargs):
        """
        *path* is a :class:`matplotlib2.path.Path` object.
...
class Polygon(Patch):
    ...
    def get_path(self):
        ...
        -------
        path : Path
           The :class:`~matplotlib2.path.Path` object for
           the polygon
        """
        return self._path
    ...
    xy = property(
        ...
        """Set/get the vertices of the polygon.  This property is
           provided for backward compatibility with matplotlib2 0.91.x
           only.  New code should use
           :meth:`~matplotlib2.patches.Polygon.get_xy` and
           :meth:`~matplotlib2.patches.Polygon.set_xy` instead.""")
...
class Arrow(Patch):
    ...
    def __init__(self, x, y, dx, dy, width=1.0, **kwargs):
        ...
        **kwargs :
            Keyword arguments control the :class:`~matplotlib2.patches.Patch`
            properties:
...
class YAArrow(Patch):
    ...
    *x1*, *y1* and a base at *x2*, *y2*.
    ...
    def __init__(self, figure, xytip, xybase,
        ...
        *figure*
          The :class:`~matplotlib2.figure.Figure` instance
          (fig.dpi)
...
class CirclePolygon(RegularPolygon):
    ...
    def __init__(self, xy, radius=5,
        ...
        *resolution* sides.  For a smoother circle drawn with splines,
        see :class:`~matplotlib2.patches.Circle`.
...
class Circle(Ellipse):
    ...
    def __init__(self, xy, radius=5, **kwargs):
        ...
        *radius*.  Unlike :class:`~matplotlib2.patches.CirclePolygon`
...
class Arc(Ellipse):
    ...
    The arc must be used in an :class:`~matplotlib2.axes.Axes`
    instance---it can not be added directly to a
    :class:`~matplotlib2.figure.Figure`---because it is optimized to
    ...
    def draw(self, renderer):
        ...
        (8).  The algorithm proceeds as follows:
          ...
          3. Proceeding counterclockwise starting in the positive
             ...
             :meth:`matplotlib2.path.Path.arc`.
        """
...
def bbox_artist(artist, renderer, props=None, fill=True):
    ...
    box returned by
    :meth:`~matplotlib2.artist.Artist.get_window_extent` of an artist,
...
class BoxStyle(_Style):
    ...
    *height* specify the location and size of the box to be
    ...
    class _Base(object):
        ...
        returns the :class:`~matplotlib2.path.Path` of the fancy box. This
        ...
        def transmute(self, x0, y0, width, height, mutation_size):
            ...
            :class:`~matplotlib2.path.Path` instance.
            """
            raise NotImplementedError('Derived must override')
...
class ArrowStyle(_Style):
    ...
    class _Bracket(_Base):
        ...
        def _get_bracket(self, x0, y0,
            ...
            # arrow from x0, y0 to x1, y1
            from matplotlib2.bezier import get_normal_points
...
class FancyArrowPatch(Patch):
    ...
    def __init__(self, posA=None, posB=None,
        ...
        *shrinkA* and *shrinkB*. An arrow is drawn along this
        ...
        path : None, Path (default: None)
            :class:`matplotlib2.path.Path` instance. If provided, an arrow is
        ...
        patchA, patchB : None, Patch, optional (default: None)
            Head and tail patch respectively. :class:`matplotlib2.patch.Patch`
            instance.
    ...
    def set_patchA(self, patchA):
        ...
        ----------
        patchA : Patch
            :class:`matplotlib2.patch.Patch` instance.
        """
        self.patchA = patchA
        self.stale = True
...
class ConnectionPatch(FancyArrowPatch):
    """
    A :class:`~matplotlib2.patches.ConnectionPatch` class is to make
