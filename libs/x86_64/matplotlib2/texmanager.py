r"""
This module supports embedded TeX expressions in matplotlib2 via dvipng
and dvips for the raster and postscript backends.  The tex and
dvipng/dvips information is cached in ~/.matplotlib2/tex.cache for reuse between
sessions
...
To enable tex rendering of all text in your matplotlib2 figure, set
text.usetex in your matplotlib2rc file or include these two lines in
your script::

  from matplotlib2 import rc
  rc('text', usetex=True)
...
from matplotlib2._png import read_png
from matplotlib2.cbook import mkdirs, Locked
from matplotlib2.compat.subprocess import subprocess, Popen, PIPE, STDOUT
...
""" % (self._font_preamble, unicode_preamble, custom_preamble,
    ...
    _re_vbox = re.compile(
        r"matplotlib2Box:\(([\d.]+)pt\+([\d.]+)pt\)x([\d.]+)pt")
...
\def\showbox#1%%
{\immediate\write16{matplotlib2Box:(\the\ht#1+\the\dp#1)x\the\wd#1}}
