...
class Collection(artist.Artist, cm.ScalarMappable):
    ...
    Keyword arguments and default values:
        ...
        * *norm*: None (optional for
          :class:`matplotlib2.cm.ScalarMappable`)
    ...
    *offsets* and *transOffset* are used to translate the patch after
    ...
    are None, they default to their :data:`matplotlib2.rcParams` patch
    setting, in sequence form.

    The use of :class:`~matplotlib2.cm.ScalarMappable` is optional.  If
    the :class:`~matplotlib2.cm.ScalarMappable` matrix _A is not None
    ...
    #: :meth:`~matplotlib2.backend_bases.RendererBase.draw_path_collection`;
    #: each 3x3 array is used to initialize an
    #: :class:`~matplotlib2.transforms.Affine2D` object.
    ...
    def set_color(self, c):
        ...
        ACCEPTS: matplotlib2 color arg or sequence of rgba tuples
    ...
    def set_facecolor(self, c):
        ...
        matplotlib2 color spec (all patches have same color), or a
        sequence of specs; if it is a sequence the patches will
        cycle through the sequence.

        If *c* is 'none', the patch will not be filled.

        ACCEPTS: matplotlib2 color spec or sequence of specs
        """
...
class PathCollection(_CollectionWithSizes):
    ...
    def __init__(self, paths, sizes=None, **kwargs):
        """
        *paths* is a sequence of :class:`matplotlib2.path.Path`
        instances.
...
class LineCollection(Collection):
    ...
    def __init__(self, segments,     # Can be None.
        ...
        *offsets* are added to the segments before any transformation.
        ...
        The use of :class:`~matplotlib2.cm.ScalarMappable` is optional.
        If the :class:`~matplotlib2.cm.ScalarMappable` array
        :attr:`~matplotlib2.cm.ScalarMappable._A` is not None (i.e., a call to
        :meth:`~matplotlib2.cm.ScalarMappable.set_array` has been made), at
    ...
    def set_color(self, c):
        ...
        ----------
        c :
            matplotlib2 color argument (all patches have same color), or a
    ...
    def __init__(self, widths, heights, angles, units='points', **kwargs):
        ...
        *units*: ['points' | 'inches' | 'dots' | 'width' | 'height'
        | 'x' | 'y' | 'xy']
            ...
            the :class:`~matplotlib2.patches.Ellipse` with
...
class PatchCollection(Collection):
    ...
    def __init__(self, patches, match_original=False, **kwargs):
        ...
        *antialiaseds* are None, they default to their
        :data:`matplotlib2.rcParams` patch setting, in sequence form.

        The use of :class:`~matplotlib2.cm.ScalarMappable` is optional.
        If the :class:`~matplotlib2.cm.ScalarMappable` matrix _A is not
...
class TriMesh(Collection):
    ...
    A triangular mesh is a :class:`~matplotlib2.tri.Triangulation`
    object.
    """
    ...
    def convert_mesh_to_paths(tri):
        ...
        :class:`matplotlib2.path.Path` objects for easier rendering by
