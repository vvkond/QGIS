...
All of these widgets require you to predefine a :class:`matplotlib2.axes.Axes`
instance and pass that as the first arg.  matplotlib2 doesn't try to
...
class LockDraw(object):
    ...
    drawing.  Use ``matplotlib2.widgets.lock(someobj)`` to prevent
...
class AxesWidget(Widget):
    ...
    *ax* : :class:`~matplotlib2.axes.Axes`
        The parent axes for the widget
    *canvas* : :class:`~matplotlib2.backend_bases.FigureCanvasBase` subclass
...
class Button(AxesWidget):
    ...
    ----------
    ax :
        The :class:`matplotlib2.axes.Axes` the button renders into.
    label :
        A :class:`matplotlib2.text.Text` instance.
    color :
    ...
    def __init__(self, ax, label, image=None,
        ...
        Parameters
        ----------
        ax : matplotlib2.axes.Axes
            The :class:`matplotlib2.axes.Axes` instance the button
            will be placed into.
        ...
        image : array, mpl image, Pillow Image
            ...
            matplotlib2 Image instance, or Pillow Image).
...
class Slider(AxesWidget):
    ...
    def __init__(self, ax, label, valmin, valmax, valinit=0.5, valfmt='%1.2f',
        ...
        :class:`~matplotlib2.patches.Rectangle` that draws the slider
        knob.  See the :class:`~matplotlib2.patches.Rectangle` documentation for
...
class CheckButtons(AxesWidget):
     ...
     *ax*
        The :class:`matplotlib2.axes.Axes` instance the buttons are
        located in
     ...
     *rectangles*
        List of :class:`matplotlib2.patches.Rectangle` instances

    Connect to the CheckButtons with the :meth:`on_clicked` method
    """
    def __init__(self, ax, labels, actives):
        """
        Add check buttons to :class:`matplotlib2.axes.Axes` instance *ax*
...
class RadioButtons(AxesWidget):
     ...
     *ax*
        The :class:`matplotlib2.axes.Axes` instance the buttons are in

     *activecolor*
        The color of the button when clicked

     *labels*
        A list of :class:`matplotlib2.text.Text` instances

     *circles*
        A list of :class:`matplotlib2.patches.Circle` instances
    ...
    def __init__(self, ax, labels, active=0, activecolor='blue'):
        """
        Add radio buttons to :class:`matplotlib2.axes.Axes` instance *ax*
...
class SubplotTool(Widget):
    """
    A tool to adjust the subplot params of a :class:`matplotlib2.figure.Figure`.
    """
...
class MultiCursor(Widget):
    ...
    Example usage::
        ...
        from matplotlib2.widgets import MultiCursor
...
class SpanSelector(_SelectorWidget):
    ...
    Parameters
    ----------
    ax :  :class:`matplotlib2.axes.Axes` object
    ...
    rectprops : dict, default is None
      Dictionary of :class:`matplotlib2.patches.Patch` properties
    ...
    >>> import matplotlib2.widgets as mwidgets
    >>> fig, ax = plt.subplots()
...
class ToolHandles(object):
    ...
    ----------
    ax : :class:`matplotlib2.axes.Axes`
        matplotlib2 axes where tool handles are displayed.
    x, y : 1D arrays
        Coordinates of control handles.
    marker : str
        Shape of marker used to display handle. See `matplotlib2.pyplot.plot`.
    marker_props : dict
        Additional marker properties. See :class:`matplotlib2.lines.Line2D`.
    """
...
class RectangleSelector(_SelectorWidget):
    ...
    Example usage::
        ...
        from matplotlib2.widgets import  RectangleSelector
        from pylab import *

        def onselect(eclick, erelease):
          'eclick and erelease are matplotlib2 events at press and release'
...
class EllipseSelector(RectangleSelector):
    ...
    Example usage::
        ...
        from matplotlib2.widgets import  EllipseSelector
        from pylab import *
...
class Lasso(AxesWidget):
    ...
    :func:`~matplotlib2.path.Path.contains_point` to select data points
    from an image.
