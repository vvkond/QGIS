...
# Note, matplotlib2 artists use the doc strings for set and get
...
class Artist(object):
    ...
    def remove(self):
        ...
        :meth:`matplotlib2.axes.Axes.draw_idle`.  Call
        :meth:`matplotlib2.axes.Axes.relim` to update the axes limits
        if desired.

        Note: :meth:`~matplotlib2.axes.Axes.relim` will not see
    ...
    def axes(self):
        """
        The :class:`~matplotlib2.axes.Axes` instance the artist
        resides in, or *None*.
        """
        return self._axes
    ...
    def set_clip_path(self, path, transform=None):
        ...
        - a :class:`~matplotlib2.patches.Patch` (or subclass) instance; or
        - a :class:`~matplotlib2.path.Path` instance, in which case a
          :class:`~matplotlib2.transforms.Transform` instance, which will be
        ...
        ACCEPTS: [(`~matplotlib2.path.Path`, `.Transform`) | `.Patch` | None]
        """
        from matplotlib2.patches import Patch, Rectangle
    ...
    def findobj(self, match=None, include_self=True):
        ...
        Recursively find all :class:`~matplotlib2.artist.Artist` instances
        contained in self.
        ...
        *match* can be
        ...
        if match is None:  # always return True
            ...
            raise ValueError('match must be None, a matplotlib2.artist.Artist '
...
class ArtistInspector(object):
    """
    A helper class to inspect an :class:`~matplotlib2.artist.Artist`
    ...
    def get_aliases(self):
        ...
        the :class:`~matplotlib2.artist.ArtistInspector`.
...
def getp(obj, property=None):
    ...
    *obj* is a :class:`Artist` instance, e.g.,
    ...
    :class:`~matplotlib2.axes.Axes` or :class:`matplotlib2.text.Text`.
...
def setp(obj, *args, **kwargs):
    ...
    matplotlib2 supports the use of :func:`setp` ("set property") and
...
def kwdoc(a):
    hardcopy = matplotlib2.rcParams['docstring.hardcopy']
    if hardcopy:
