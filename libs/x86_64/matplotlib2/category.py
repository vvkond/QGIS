...
The module uses matplotlib2's `matplotlib2.units` mechanism to convert from
...
class StrCategoryConverter(units.ConversionInterface):
    ...
    def convert(value, unit, axis):
        ...
        axis : :class:`~matplotlib2.Axis.axis`
    ...
    def axisinfo(unit, axis):
        ...
        Returns
        -------
        :class:~matplotlib2.units.AxisInfo~
    ...
    def default_units(data, axis):
        """ Sets and updates the :class:`~matplotlib2.Axis.axis~ units
...
# Connects the convertor to matplotlib2
