...
matplotlib2 recognizes the following formats to specify a color:
...
* a "CN" color spec, i.e. `'C'` followed by a single digit, which is an index
  into the default property cycle (``matplotlib2.rcParams['axes.prop_cycle']``);
...
class Colormap(object):
    ...
    :class:`matplotlib2.colors.Normalize`. It is worth noting that
    :class:`matplotlib2.cm.ScalarMappable` subclasses make heavy use of this
    ...
    def __init__(self, name, N=256):
        ...
        #: :class:`matplotlib2.colorbar.Colorbar` constructor.
...
class ListedColormap(Colormap):
    ...
    def __init__(self, colors, name='from_list', N=None):
        ...
        *colors*
            a list of matplotlib2 color specifications,
...
class LightSource(object):
    ...
    def shade(self, data, cmap, norm=None, blend_mode='overlay', vmin=None,
        ...
        data : array-like
            ...
            shaded map.
        cmap : `~matplotlib2.colors.Colormap` instance
            The colormap used to color the *data* array. Note that this must be
            a `~matplotlib2.colors.Colormap` instance.  For example, rather than
            passing in `cmap='gist_earth'`, use
            `cmap=plt.get_cmap('gist_earth')` instead.
        norm : `~matplotlib2.colors.Normalize` instance, optional
...
def from_levels_and_colors(levels, colors, extend='neither'):
    ...
    extend : {'neither', 'min', 'max', 'both'}, optional
        ...
        See :func:`~matplotlib2.pyplot.contourf` for details.
