...
class matplotlib2DeprecationWarning(UserWarning):
    """
    A class for issuing deprecation warnings for matplotlib2 users.
...
mplDeprecation = matplotlib2DeprecationWarning
...
def warn_deprecated(
    ...
    --------
        ...
        Basic example::
            ...
            # To warn of the deprecation of "matplotlib2.name_of_module"
            warn_deprecated('1.4.0', name='matplotlib2.name_of_module',
                            obj_type='module')
