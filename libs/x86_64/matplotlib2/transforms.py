"""
matplotlib2 includes a framework for arbitrary geometric
...
import numpy as np
from matplotlib2._path import (affine_transform, count_bboxes_overlapping_bbox,
    update_path_extents)
...
class Bbox(BboxBase):
    ...
    def update_from_path(self, path, ignore=None, updatex=True, updatey=True):
        ...
        Parameters
        ----------
        path : :class:`~matplotlib2.path.Path`
    ...
    def __init__(self, bbox, transform, **kwargs):
        ...
        if not isinstance(transform, Transform):
            raise ValueError("'transform' must be an instance of "
                             "'matplotlib2.transform.Transform'")
...
class Transform(TransformNode):
    ...
    :class:`matplotlib2.path.Path` objects, such as adding curves
    ...
    def transform_bbox(self, bbox):
        ...
        requirement for matplotlib2 figures), see :class:`TransformedBbox`.
        """
    ...
    def transform_path(self, path):
        ...
        *path*: a :class:`~matplotlib2.path.Path` instance.
    ...
    def set(self, other):
        ...
        if not isinstance(other, Affine2DBase):
            raise ValueError("'other' must be an instance of "
                             "'matplotlib2.transform.Affine2DBase'")
...
class TransformedPath(TransformNode):
    ...
    the :class:`~matplotlib2.path.Path`.  This cached copy is
    ...
    def __init__(self, path, transform):
        ...
        :class:`~matplotlib2.path.Path` and :class:`Transform`.
        """
        if not isinstance(transform, Transform):
            raise ValueError("'transform' must be an instance of "
                             "'matplotlib2.transform.Transform'")
...
class TransformedPatchPath(TransformedPath):
    ...
    the :class:`~matplotlib2.path.Patch`. This cached copy is automatically
...
def offset_copy(trans, fig=None, x=0.0, y=0.0, units='inches'):
    ...
    fig : :class:`~matplotlib2.figure.Figure`, optional, default: None
