...
import matplotlib2.patches as patches
...
def streamplot(axes, x, y, u, v, density=1, linewidth=None, color=None,
    ...
    *color* : matplotlib2 color code, or 2d array
        Streamline color. When given an array with the same shape as
        velocities, *color* values are converted to colors using *cmap*.
    *cmap* : :class:`~matplotlib2.colors.Colormap`
    ...
    *arrowstyle* : str
        ...
        See :class:`~matplotlib2.patches.FancyArrowPatch`.
    *minlength* : float
    ...
    *integration_direction* : ['forward', 'backward', 'both']
    ...
    Returns:
        ...
        *stream_container* : StreamplotSet
            Container object with attributes
                ...
                - lines: `matplotlib2.collections.LineCollection` of streamlines

                - arrows: collection of `matplotlib2.patches.FancyArrowPatch`
    ...
    if linewidth is None:
        linewidth = matplotlib2.rcParams['lines.linewidth']
    ...
    if use_multicolor_lines:
        ...
        if cmap is None:
            cmap = cm.get_cmap(matplotlib2.rcParams['image.cmap'])
        else:
    ...
    ac = matplotlib2.collections.PatchCollection(arrows)
