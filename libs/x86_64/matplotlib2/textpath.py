...
from matplotlib2.ft2font import LOAD_TARGET_LIGHT
from matplotlib2.mathtext import MathTextParser
import matplotlib2.dviread as dviread
from matplotlib2.font_manager import FontProperties, get_font
...
class TextToPath(object):
    ...
    def get_glyphs_tex(self, prop, s, glyph_map=None,
                       return_new_glyphs_only=False):
        """
        convert the string *s* to vertices and codes using matplotlib2's usetex
        mode.
        """
