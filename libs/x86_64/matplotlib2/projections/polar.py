...
class RadialLocator(mticker.Locator):
    ...
    :class:`~matplotlib2.ticker.Locator` (which may be different
...
def _is_full_circle_deg(thetamin, thetamax):
    ...
    The condition is derived from :class:`~matplotlib2.patches.Wedge`.
    """
...
class _WedgeBbox(mtransforms.Bbox):
    ...
    center : tuple of float
        Center of the wedge
    viewLim : `~matplotlib2.transforms.Bbox`
        Bbox determining the boundaries of the wedge
    originLim : `~matplotlib2.transforms.Bbox`
...
class PolarAxes(Axes):
    ...
    def set_thetagrids(self, angles, labels=None, frac=None, fmt=None,
        ...
        *line* is :class:`~matplotlib2.lines.Line2D` instances and the
        *label* is :class:`~matplotlib2.text.Text` instances.
