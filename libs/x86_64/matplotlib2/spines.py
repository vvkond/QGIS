...
class Spine(mpatches.Patch):
    ...
    positions. See function:`~matplotlib2.spines.Spine.set_position`
    for more information.

    The default position is ``('outward',0)``.

    Spines are subclasses of class:`~matplotlib2.patches.Patch`, and
    inherit much of their behavior.

    Spines draw a line, a circle, or an arc depending if
    function:`~matplotlib2.spines.Spine.set_patch_line`,
    function:`~matplotlib2.spines.Spine.set_patch_circle`, or
    function:`~matplotlib2.spines.Spine.set_patch_arc` has been called.
    ...
    def __init__(self, axes, spine_type, path, **kwargs):
        ...
        self._position = None
        if not isinstance(path, matplotlib2.path.Path):
            raise ValueError(
                "'path' must be an instance of 'matplotlib2.path.Path'")
        self._path = path
