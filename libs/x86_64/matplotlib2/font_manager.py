...
License   : matplotlib2 license (PSF compatible)
...
from matplotlib2 import afm, cbook, ft2font, rcParams, get_cachedir
from matplotlib2.compat import subprocess
from matplotlib2.fontconfig_pattern import (
...
def _call_fc_list():
    ...
    timer = Timer(5, lambda: warnings.warn(
        'matplotlib2 is building the font cache using fc-list. '
...
class FontProperties(object):
    ...
    specification.  The six properties are:
      ...
      - family: A list of font names in decreasing order of priority.
        ...
        from the associated rcParam in :file:`matplotlib2rc`.
    ...
    default :file:`matplotlib2rc` file) is::
    ...
    Note that matplotlib2's internal font manager and fontconfig use a
    different algorithm to lookup fonts, so the results of the same pattern
    may be different in matplotlib2 than in other applications that use
    fontconfig.
    """
