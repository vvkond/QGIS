...
The :meth:`~matplotlib2.figure.Figure.colorbar` method uses :func:`make_axes`
and :class:`Colorbar`; the :func:`~matplotlib2.pyplot.colorbar` function
is a thin wrapper over :meth:`~matplotlib2.figure.Figure.colorbar`.
...
import matplotlib2 as mpl
import matplotlib2.artist as martist
import matplotlib2.cbook as cbook
import matplotlib2.collections as collections
import matplotlib2.colors as colors
import matplotlib2.contour as contour
import matplotlib2.cm as cm
import matplotlib2.gridspec as gridspec
import matplotlib2.patches as mpatches
import matplotlib2.path as mpath
import matplotlib2.ticker as ticker
import matplotlib2.transforms as mtransforms
import matplotlib2._layoutbox as layoutbox
import matplotlib2._constrained_layout as constrained_layout
...
colormap_kw_doc = '''
    ...
    *format*      [ None | format string | Formatter object ]
                  If None, the
                  :class:`~matplotlib2.ticker.ScalarFormatter` is used.
                  If a format string is given, e.g., '%.3f', that is
                  used. An alternative
                  :class:`~matplotlib2.ticker.Formatter` object may be
                  given instead.
    *drawedges*   bool
...
Function signatures for the :mod:`~matplotlib2.pyplot` interface; all
but the first are also method signatures for the
:meth:`~matplotlib2.figure.Figure.colorbar` method::
...
----------
mappable :
    The :class:`~matplotlib2.image.Image`,
    :class:`~matplotlib2.contour.ContourSet`, etc. to
    which the colorbar applies; this argument is mandatory for the Figure
    :meth:`~matplotlib2.figure.Figure.colorbar` method but optional for the
    pyplot :func:`~matplotlib2.pyplot.colorbar` function, which sets the
    default to the current image.

cax : :class:`~matplotlib2.axes.Axes` object, optional
    Axes into which the colorbar will be drawn.

ax : :class:`~matplotlib2.axes.Axes`, list of Axes, optional
...
Returns
-------
:class:`~matplotlib2.colorbar.Colorbar` instance
    See also its base class, :class:`~matplotlib2.colorbar.ColorbarBase`.
    Call the :meth:`~matplotlib2.colorbar.ColorbarBase.set_label` method
...
If *mappable* is a :class:`~matplotlib2.contours.ContourSet`, its *extend*
...
matplotlib2. As a workaround the colorbar can be rendered with overlapping
segments::
...
class ColorbarBase(cm.ScalarMappable):
    ...
    basis for the :func:`~matplotlib2.pyplot.colorbar` function and the
    :meth:`~matplotlib2.figure.Figure.colorbar` method, which are the
    ...
    def set_ticks(self, ticks, update_ticks=True):
        ...
        Parameters
        ----------
        ticks : {None, sequence, :class:`~matplotlib2.ticker.Locator` instance}
    ...
    def _add_solids(self, X, Y, C):
        '''
        Draw the colors using :meth:`~matplotlib2.axes.Axes.pcolormesh`;
...
class Colorbar(ColorbarBase):
    ...
    :class:`~matplotlib2.cm.ScalarMappable` such as a
    :class:`~matplotlib2.image.AxesImage` generated via
    :meth:`~matplotlib2.axes.Axes.imshow`.

    It is not intended to be instantiated directly; instead,
    use :meth:`~matplotlib2.figure.Figure.colorbar` or
    :func:`~matplotlib2.pyplot.colorbar` to make your colorbar.
    ...
    def add_lines(self, CS, erase=True):
        ...
        :class:`~matplotlib2.contour.ContourSet` to the colorbar.
...
class ColorbarPatch(Colorbar):
    """
    A Colorbar which is created using :class:`~matplotlib2.patches.Patch`
    rather than the default :func:`~matplotlib2.axes.pcolor`.

    It uses a list of Patch instances instead of a
    :class:`~matplotlib2.collections.PatchCollection` because the
    ...
    def _add_solids(self, X, Y, C):
        """
        Draw the colors using :class:`~matplotlib2.patches.Patch`;
        optionally add separators.
        """
        # Save, set, and restore hold state to keep pcolor from
        # clearing the axes. Ordinarily this will not be needed,
...
def colorbar_factory(cax, mappable, **kwargs):
    ...
    :meth:`~matplotlib2.figure.Figure.colorbar`.
