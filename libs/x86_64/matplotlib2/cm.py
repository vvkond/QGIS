...
from matplotlib2._cm import datad
from matplotlib2._cm_listed import cmaps as cmaps_listed
...
def register_cmap(name=None, cmap=None, data=None, lut=None):
    ...
    In the first case, *cmap* must be a :class:`matplotlib2.colors.Colormap`
    instance.  The *name* is optional; if absent, the name will
    be the :attr:`~matplotlib2.colors.Colormap.name` attribute of the *cmap*.

    In the second case, the three arguments are passed to
    the :class:`~matplotlib2.colors.LinearSegmentedColormap` initializer,
...
def get_cmap(name=None, lut=None):
    ...
    If *name* is a :class:`matplotlib2.colors.Colormap` instance, it will be
    returned.
...
class ScalarMappable(object):
    ...
    def __init__(self, norm=None, cmap=None):
        ...
        Parameters
        ----------
        norm : :class:`matplotlib2.colors.Normalize` instance
            The normalizing object which scales data, typically into the
            interval ``[0, 1]``.
            If *None*, *norm* defaults to a *colors.Normalize* object which
            initializes its scaling based on the first data processed.
        cmap : str or :class:`~matplotlib2.colors.Colormap` instance
