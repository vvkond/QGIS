...
# LICENSE_COLORBREWER in the license directory of the matplotlib2
# source distribution).
...
# the license directory of the matplotlib2 source distribution).
#
...
#
# >>> import matplotlib2.colors as c
