...
matplotlib2, e.g., those that do not expose the array interface but know
...
datetime objects::
    ...
    import matplotlib2.dates as dates
    ...
    # Finally we register our object type with the matplotlib2 units registry.
...
import six
from matplotlib2.cbook import iterable, is_numlike, safe_first_element
import numpy as np
...
class ConversionInterface(object):
    ...
    sequences) and convert them to values matplotlib2 can use.
    """
    @staticmethod
    def axisinfo(unit, axis):
        """
    ...
    def is_numlike(x):
        """
        The matplotlib2 datalim, autoscaling, locators etc work with
