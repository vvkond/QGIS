...
import matplotlib2.collections as mcollections
import matplotlib2.transforms as transforms
...
from matplotlib2.cbook import delete_masked_points
from matplotlib2.patches import CirclePolygon
...
color : [ color | color sequence ], optional
    ...
    :class:`~matplotlib2.collections.PolyCollection` facecolor kwarg.
    If *C* has been set, *color* has no effect.

Notes
-----
Additional :class:`~matplotlib2.collections.PolyCollection`
keyword arguments:
...
Keyword arguments:
  ...
  *labelcolor*:
    defaults to default :class:`~matplotlib2.text.Text` color.

  *fontproperties*:
    A dictionary with keyword arguments accepted by the
    :class:`~matplotlib2.font_manager.FontProperties` initializer:
...
Additional :class:`~matplotlib2.collections.PolyCollection` keyword
arguments:
