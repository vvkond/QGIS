...
class Line2D(Artist):
    ...
    def __init__(self, xdata, ydata,
        ...
        """
        Create a :class:`~matplotlib2.lines.Line2D` instance with *x*
        and *y* data in sequences *xdata*, *ydata*.

        The kwargs are :class:`~matplotlib2.lines.Line2D` properties:
    ...
    def contains(self, mouseevent):
        ...
        :meth:`~matplotlib2.lines.Line2D.get_pickradius` or
        :meth:`~matplotlib2.lines.Line2D.set_pickradius` to view or
        modify it.
...
| float | length-2 tuple of float
    ...
    def _get_transformed_path(self):
        """
        Return the :class:`~matplotlib2.transforms.TransformedPath` instance
        of this line.
        """
    ...
    def get_path(self):
        """
        Return the :class:`~matplotlib2.path.Path` object associated
        with this line.
        """
        if self._invalidy or self._invalidx:
            self.recache()
    ...
    def set_marker(self, marker):
        ...
        ACCEPTS: :mod:`A valid marker style <matplotlib2.markers>`

        Parameters
        ----------

        marker: marker style
            See `~matplotlib2.markers` for full description of possible
            argument
...
class VertexSelector(object):
    ...
    :class:`matplotlib2.lines.Line2D`. Derived classes should override
    :meth:`~matplotlib2.lines.VertexSelector.process_selected` to do
    ...
    circles::
        ...
        import matplotlib2.lines as lines
    ...
    def __init__(self, line):
        """
        Initialize the class with a :class:`matplotlib2.lines.Line2D`
        instance.  The line should already be added to some
        :class:`matplotlib2.axes.Axes` instance and should have the
        picker property set.
        """
