...
:class:`~matplotlib2.artist.Artist`, the :class:`Figure`, which
...
from matplotlib2 import rcParams
from matplotlib2 import docstring
from matplotlib2 import __version__ as _mpl_version

import matplotlib2.artist as martist
from matplotlib2.artist import Artist, allow_rasterization

import matplotlib2.cbook as cbook

from matplotlib2.cbook import Stack, iterable

from matplotlib2 import image as mimage
from matplotlib2.image import FigureImage

import matplotlib2.colorbar as cbar

from matplotlib2.axes import Axes, SubplotBase, subplot_class_factory
from matplotlib2.blocking_input import BlockingMouseInput, BlockingKeyMouseInput
from matplotlib2.gridspec import GridSpec
import matplotlib2.legend as mlegend
from matplotlib2.patches import Rectangle
from matplotlib2.projections import (get_projection_names,
                                    process_projection_requirements)
from matplotlib2.text import Text, _process_text_args
from matplotlib2.transforms import (Affine2D, Bbox, BboxTransformTo,
                                   TransformedBbox)
import matplotlib2._layoutbox as layoutbox
from matplotlib2.backend_bases import NonGuiException
...
class AxesStack(Stack):
    ...
    `~matplotlib2.axes.Axes` in a `.Figure`.
...
class Figure(Artist):
    ...
    def _repr_html_(self):
        ...
        if (self.canvas is not None and
            ...
            from matplotlib2.backends import backend_webagg
    ...
    def show(self, warn=True):
        ...
        :func:`~matplotlib2.pyplot.figure`, it will lack a
        :class:`~matplotlib2.backend_bases.FigureManagerBase`, and
        ...
        if warn:
            import warnings
            warnings.warn(
                "matplotlib2 is currently using a non-GUI backend, "
    ...
    def suptitle(self, t, **kwargs):
        ...
        kwargs are :class:`matplotlib2.text.Text` properties.  Using figure
        ...
        A :class:`matplotlib2.text.Text` instance is returned.
    ...
    def figimage(self, X, xo=0, yo=0, alpha=None, norm=None, cmap=None,
        ...
        *origin*.
        ...
        norm : :class:`matplotlib2.colors.Normalize`
            A :class:`.Normalize` instance to map the luminance to the
            interval [0, 1].

        cmap : str or :class:`matplotlib2.colors.Colormap`
        ...
        Returns
        -------
        :class:`matplotlib2.image.FigureImage`
        ...
        **kwargs
        ...
        (:meth:`~matplotlib2.axes.Axes.imshow`) which will be resampled
        to fit the current axes.  If you want a resampled image to
        fill the entire figure, you can define an
        :class:`~matplotlib2.axes.Axes` with extent [0,0,1,1].
    ...
    def set_size_inches(self, w, h=None, forward=True):
        ...
        See Also
        --------
        matplotlib2.Figure.get_size_inches
        """
    ...
    def get_size_inches(self):
        ...
        See Also
        --------
        matplotlib2.Figure.set_size_inches
        """
    ...
    def set_edgecolor(self, color):
        ...
        ACCEPTS: any matplotlib2 color - see help(colors)
        """
    ...
    def delaxes(self, ax):
        """
        Remove the `~matplotlib2.axes.Axes` *ax* from the figure and update the
        current axes.
        """
...
'polar', rectilinear'}, optional
        ...
        **kwargs
        ...
        has been deprecated as of matplotlib2 2.1.  Meanwhile, if you do
        not want this behavior (i.e., you want to force the creation of a
        new Axes), you must use a unique set of args and kwargs.  The axes
        :attr:`~matplotlib2.axes.Axes.label` attribute has been exposed for this
        ...
        In all cases, the :class:`~matplotlib2.axes.Axes` instance
        will be returned.
        """
        if not len(args):
            return
...
'polar', rectilinear'}, optional
        ...
        *kwargs*) then it will simply make that subplot current and
        ...
        See Also
        --------
        matplotlib2.pyplot.subplot : for an explanation of the args.
        """
        if not len(args):
            return
    ...
    def subplots(self, nrows=1, ncols=1, sharex=False, sharey=False,
        ...
        sharex, sharey : bool or {'none', 'all', 'row', 'col'}, default: False
            ...
            ticklabels on, use :meth:`~matplotlib2.axes.Axes.tick_params`.
        ...
        subplot_kw : dict, default: {}
            ...
            :meth:`~matplotlib2.figure.Figure.add_subplot` call used to create
            each subplots.

        gridspec_kw : dict, default: {}
            Dict with keywords passed to the
            :class:`~matplotlib2.gridspec.GridSpec` constructor used to create
    ...
    def draw(self, renderer):
        """
        Render the figure using :class:`matplotlib2.backend_bases.RendererBase`
        instance *renderer*.
        """
    ...
    def draw_artist(self, a):
        """
        Draw :class:`matplotlib2.artist.Artist` instance *a* only.
...
'large', 'x-large', 'xx-large'}
    ...
    def text(self, x, y, s, *args, **kwargs):
        ...
        coords). See :func:`~matplotlib2.pyplot.text` for the meaning
        of the other arguments.

        kwargs control the :class:`~matplotlib2.text.Text` properties:
    ...
    def _gci(self):
        """
        Helper for :func:`~matplotlib2.pyplot.gci`. Do not use elsewhere.
        """
    ...
    def __getstate__(self):
        ...
        if getattr(self.canvas, 'manager', None) is not None:
            ...
            import matplotlib2._pylab_helpers
            if manager in list(six.itervalues(
                    matplotlib2._pylab_helpers.Gcf.figs)):
    ...
    def __setstate__(self, state):
        ...
        if version != _mpl_version:
            import warnings
            warnings.warn("This figure was saved with matplotlib2 version %s "
        ...
        if restore_to_pylab:
            ...
            import matplotlib2._pylab_helpers as pylab_helpers
    ...
    def savefig(self, fname, **kwargs):
        ...
        fname : str or file-like object
            ...
            such as :class:`~matplotlib2.backends.backend_pdf.PdfPages`.
        ...
        dpi : [ *None* | scalar > 0 | 'figure']
            ...
            the value ``savefig.dpi`` in the matplotlib2rc file. If 'figure'
        ...
        bbox_inches : str or `~matplotlib2.transforms.Bbox`, optional
        ...
        bbox_extra_artists : list of `~matplotlib2.artist.Artist`, optional
    ...
    def execute_constrained_layout(self, renderer=None):
        ...
        from matplotlib2._constrained_layout import (do_constrained_layout)
    ...
    def align_xlabels(self, axs=None):
        ...
        Parameters
        ----------
        axs : list of `~matplotlib2.axes.Axes`
            Optional list of (or ndarray) `~matplotlib2.axes.Axes`
            to align the xlabels.
            Default is to align all axes on the figure.

        See Also
        --------
        matplotlib2.figure.Figure.align_ylabels

        matplotlib2.figure.Figure.align_labels
    ...
    def align_ylabels(self, axs=None):
        ...
        ----------
        axs : list of `~matplotlib2.axes.Axes`
            Optional list (or ndarray) of `~matplotlib2.axes.Axes`
            to align the ylabels.
            Default is to align all axes on the figure.

        See Also
        --------
        matplotlib2.figure.Figure.align_xlabels
