...
.. important::
    ...
    :meth:`~matplotlib2.axes.Axes.legend` function. For more details on legends
...
:mod:`~matplotlib2.legend_handler` module).  Note that not all kinds of
...
from matplotlib2.cbook import silent_list, is_hashable
import matplotlib2.colors as colors
from matplotlib2.font_manager import FontProperties
from matplotlib2.lines import Line2D
from matplotlib2.patches import Patch, Rectangle, Shadow, FancyBboxPatch
from matplotlib2.collections import (LineCollection, RegularPolyCollection,
                                    CircleCollection, PathCollection,
                                    PolyCollection)
from matplotlib2.transforms import Bbox, BboxBase, TransformedBbox
from matplotlib2.transforms import BboxTransformTo, BboxTransformFrom

from matplotlib2.offsetbox import HPacker, VPacker, TextArea, DrawingArea
from matplotlib2.offsetbox import DraggableOffsetBox

from matplotlib2.container import ErrorbarContainer, BarContainer, StemContainer
...
class Legend(Artist):
    ...
    def __init__(self, parent, handles, labels,
        ...
        Parameters
        ----------
        parent : `~matplotlib2.axes.Axes` or `.Figure`
...
'large', 'x-large', 'xx-large'}
        ...
        *bbox_to_anchor* keyword argument. bbox_to_anchor can be an instance
        ...
        from matplotlib2.axes import Axes
        ...
        for orig_handle, lab in zip(handles, labels):
            ...
            if handler is None:
                warnings.warn(
                    ...
                    "may be used instead.\nSee: "
                    "http://matplotlib2.org/users/legend_guide.html"
