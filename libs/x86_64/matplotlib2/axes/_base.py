...
from matplotlib2 import cbook
from matplotlib2.cbook import (_check_1d, _string_to_bool, iterable,
                              index_of, get_label)
...
import matplotlib2.axis as maxis
import matplotlib2.scale as mscale
import matplotlib2.spines as mspines
import matplotlib2.font_manager as font_manager
import matplotlib2.text as mtext
import matplotlib2.image as mimage
from matplotlib2.offsetbox import OffsetBox
from matplotlib2.artist import allow_rasterization
from matplotlib2.legend import Legend

from matplotlib2.rcsetup import cycler
from matplotlib2.rcsetup import validate_axisbelow
...
_hold_msg = """axes.hold is deprecated.
    See the API Changes document (http://matplotlib2.org/api/api_changes.html)
    for more details."""
...
def _process_plot_format(fmt):
    ...
    * 'C2--': the third color in the color cycle, dashed lines
    ...
    .. seealso::
        ...
        :func:`~matplotlib2.Line2D.lineStyles` and
        :func:`~matplotlib2.pyplot.colors`
...
class _AxesBase(martist.Artist):
    ...
    def __init__(self, fig, rect,
        ...
        `~matplotlib2.figure.Figure` *fig* with
        *rect=[left, bottom, width, height]* in
        `~matplotlib2.figure.Figure` coordinates
        ...
        Optional keyword arguments:
          ...
          *figure*           a :class:`~matplotlib2.figure.Figure`
                             instance
          ...
          *position*         [left, bottom, width, height] in
                             class:`~matplotlib2.figure.Figure` coords
          *sharex*           an class:`~matplotlib2.axes.Axes` instance
                             to share the x-axis with
          *sharey*           an class:`~matplotlib2.axes.Axes` instance
    ...
    def _set_lim_and_transforms(self):
        ...
        *transScale*, *transData*, *transLimits* and *transAxes*
        ...
        .. note::
            ...
            of the :class:`~matplotlib2.axes.Axes` class, and is meant
            to be overridden by new kinds of projection axes that need
            different transformations and limits. (See
            :class:`~matplotlib2.projections.polar.PolarAxes` for an
            example.
    ...
    def get_xaxis_transform(self, which='grid'):
        ...
        .. note::
            ...
            :class:`~matplotlib2.axis.Axis` class, and is meant to be
    ...
    def get_xaxis_text1_transform(self, pad_points):
        ...
        """
        labels_align = matplotlib2.rcParams["xtick.alignment"]
    ...
    def get_yaxis_text1_transform(self, pad_points):
        ...
        """
        labels_align = matplotlib2.rcParams["ytick.alignment"]
    ...
    def set_position(self, pos, which='both'):
        ...
        Parameters
        ----------
        pos : [left, bottom, width, height] or `~matplotlib2.transforms.Bbox`
    ...
    def set_aspect(self, aspect, adjustable=None, anchor=None, share=False):
        ...
        See Also
        --------
        matplotlib2.axes.Axes.set_adjustable
            defining the parameter to adjust in order to meet the required
            aspect.
        matplotlib2.axes.Axes.set_anchor
    ...
    def set_adjustable(self, adjustable, share=False):
        ...
        See Also
        --------
        matplotlib2.axes.Axes.set_aspect
    ...
    def _sci(self, im):
        """
        helper for :func:`~matplotlib2.pyplot.sci`;
        do not use elsewhere.
        """
        if isinstance(im, matplotlib2.contour.ContourSet):
    ...
    def _gci(self):
        """
        Helper for :func:`~matplotlib2.pyplot.gci`;
        do not use elsewhere.
        """
    ...
    def add_artist(self, a):
        """Add any :class:`~matplotlib2.artist.Artist` to the axes.
    ...
    def add_collection(self, collection, autolim=True):
        """
        Add a :class:`~matplotlib2.collections.Collection` instance
        to the axes.
    ...
    def add_image(self, image):
        """
        Add a :class:`~matplotlib2.image.AxesImage` to the axes.
    ...
    def add_line(self, line):
        """
        Add a :class:`~matplotlib2.lines.Line2D` to the list of plot
        lines
    ...
    def add_patch(self, p):
        """
        Add a :class:`~matplotlib2.patches.Patch` *p* to the list of
    ...
    def add_table(self, tab):
        """
        Add a :class:`~matplotlib2.table.Table` instance to the
        list of axes tables

        Parameters
        ----------
        tab: `matplotlib2.table.Table`
            Table instance

        Returns
        -------
        `matplotlib2.table.Table`: the table.
        """
    ...
    def add_container(self, container):
        """
        Add a :class:`~matplotlib2.container.Container` instance
        to the axes.
    ...
    def relim(self, visible_only=False):
        ...
        At present, :class:`~matplotlib2.collections.Collection`
    ...
    def update_datalim_bounds(self, bounds):
        ...
        :class:`~matplotlib2.transforms.Bbox` *bounds*
        """
    ...
    def autoscale_view(self, tight=None, scalex=True, scaley=True):
        ...
        *True* or *False*.  Specifying *tight* as *True* or *False*
        ...
        case, use :meth:`matplotlib2.axes.Axes.relim` prior to calling
        autoscale_view.
        """
    ...
    def grid(self, b=None, which='major', axis='both', **kwargs):
        ...
        *kwargs* are used to set the grid line properties, e.g.,::
        ...
        Valid :class:`~matplotlib2.lines.Line2D` kwargs are
    ...
    def ticklabel_format(self, **kwargs):
        """
        Change the `~matplotlib2.ticker.ScalarFormatter` used by
        ...
        :class:`~matplotlib2.ticker.ScalarFormatter` is not the
        :class:`~matplotlib2.ticker.Formatter` being used, an
    ...
    def locator_params(self, axis='both', tight=None, **kwargs):
        ...
        **kw :
            ...
            :meth:`~matplotlib2.ticker.MaxNLocator.set_params` method.
        ...
        :class:`~matplotlib2.ticker.MaxNLocator` used
    ...
    def tick_params(self, axis='both', **kwargs):
        ...
        grid_linestyle : string
            Any valid :class:`~matplotlib2.lines.Line2D` line style spec.
    ...
    def set_xscale(self, value, **kwargs):
        ...
        the `~matplotlib2.scale` module for more information.

        See also
        --------
        matplotlib2.scale.LinearScale : linear transform

        matplotlib2.scale.LogTransform : log transform

        matplotlib2.scale.SymmetricalLogTransform : symlog transform

        matplotlib2.scale.LogisticTransform : logit transform
        """
    ...
    def get_xmajorticklabels(self):
        ...
        -------
        labels : list
            List of :class:`~matplotlib2.text.Text` instances
        """
    ...
    def get_xticklabels(self, minor=False, which=None):
        """
        Get the x tick labels as a list of :class:`~matplotlib2.text.Text`
        instances.
    ...
    def get_yticklabels(self, minor=False, which=None):
        """
        Get the y tick labels as a list of :class:`~matplotlib2.text.Text`
        instances.
    ...
    def twinx(self):
        ...
        `~matplotlib2.ticker.LinearLocator`
