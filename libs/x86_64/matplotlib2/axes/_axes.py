...
import matplotlib2
from matplotlib2 import _preprocess_data

import matplotlib2.cbook as cbook
import matplotlib2.collections as mcoll
import matplotlib2.colors as mcolors
import matplotlib2.contour as mcontour
import matplotlib2.category as _  # <-registers a category unit converter
import matplotlib2.dates as _  # <-registers a date unit converter
import matplotlib2.docstring as docstring
import matplotlib2.image as mimage
import matplotlib2.legend as mlegend
import matplotlib2.lines as mlines
import matplotlib2.markers as mmarkers
import matplotlib2.mlab as mlab
import matplotlib2.path as mpath
import matplotlib2.patches as mpatches
import matplotlib2.quiver as mquiver
import matplotlib2.stackplot as mstack
import matplotlib2.streamplot as mstream
import matplotlib2.table as mtable
import matplotlib2.text as mtext
import matplotlib2.ticker as mticker
import matplotlib2.transforms as mtransforms
import matplotlib2.tri as mtri
from matplotlib2.cbook import (
    _backports, mplDeprecation, warn_deprecated,
    STEP_LOOKUP_MAP, iterable, safe_first_element)
from matplotlib2.container import BarContainer, ErrorbarContainer, StemContainer
from matplotlib2.axes._base import _AxesBase, _process_plot_format

_log = logging.getLogger(__name__)

rcParams = matplotlib2.rcParams
...
class Axes(_AxesBase):
    ...
    :class:`~matplotlib2.axis.Axis`, :class:`~matplotlib2.axis.Tick`,
    :class:`~matplotlib2.lines.Line2D`, :class:`~matplotlib2.text.Text`,
    :class:`~matplotlib2.patches.Polygon`, etc., and sets the
    coordinate system.

    The :class:`Axes` instance supports callbacks through a callbacks
    attribute which is a :class:`~matplotlib2.cbook.CallbackRegistry`
    ...
    def set_title(self, label, fontdict=None, loc="center", pad=None,
        ...
        Returns
        -------
        text : :class:`~matplotlib2.text.Text`
            The matplotlib2 text instance representing the title

        Other Parameters
        ----------------
        **kwargs : `~matplotlib2.text.Text` properties
            Other keyword arguments are text properties, see
            :class:`~matplotlib2.text.Text` for a list of valid text
            properties.
        """
        try:
            title = {'left': self._left_title,
    ...
    def legend(self, *args, **kwargs):
        ...
        **3. Explicitly defining the elements in the legend**
        ...
        prop : None or :class:`matplotlib2.font_manager.FontProperties` or dict
            The font properties of the legend. If None (default), the current
            :data:`matplotlib2.rcParams` will be used.
...
'large', 'x-large', 'xx-large'}
        ...
        fancybox : None or bool
            ...
            :class:`~matplotlib2.patches.FancyBboxPatch` which makes up the
            legend's background.
            Default is ``None``, which will take the value from
            :rc:`legend.fancybox`.
        ...
        bbox_transform : None or :class:`matplotlib2.transforms.Transform`
            The transform for the bounding box (`bbox_to_anchor`). For a value
            of ``None`` (default) the Axes'
            :data:`~matplotlib2.axes.Axes.transAxes` transform will be used.
        ...
        handler_map : dict or None
            ...
            found at :func:`matplotlib2.legend.Legend.get_legend_handler_map`.

        Returns
        -------

        :class:`matplotlib2.legend.Legend` instance
    ...
    def text(self, x, y, s, fontdict=None, withdash=False, **kwargs):
        ...
        withdash : boolean, optional, default: False
            Creates a `~matplotlib2.text.TextWithDash` instance instead of a
            `~matplotlib2.text.Text` instance.
        ...
        **kwargs : `~matplotlib2.text.Text` properties.
        ...
        text in the center of the axes::
            ...
            >>> text(0.5, 0.5, 'matplotlib2', horizontalalignment='center',
            ...      verticalalignment='center', transform=ax.transAxes)

        You can put a rectangular box around the text instance (e.g., to
        set a background color) by using the keyword `bbox`.  `bbox` is
        a dictionary of `~matplotlib2.patches.Rectangle`
    ...
    def axhline(self, y=0, xmin=0, xmax=1, **kwargs):
        ...
        Returns
        -------
        line : :class:`~matplotlib2.lines.Line2D`

        Other Parameters
        ----------------
        **kwargs :
            Valid kwargs are :class:`~matplotlib2.lines.Line2D` properties,
    ...
    def axhspan(self, ymin, ymax, xmin=0, xmax=1, **kwargs):
        ...
        Returns
        -------
        Polygon : `~matplotlib2.patches.Polygon`

        Other Parameters
        ----------------
        **kwargs : `~matplotlib2.patches.Polygon` properties.
    ...
    def axvspan(self, xmin, xmax, ymin=0, ymax=1, **kwargs):
        ...
        Returns
        -------
        rectangle : matplotlib2.patches.Polygon
    ...
    def hlines(self, y, xmin, xmax, colors='k', linestyles='solid',
        ...
        Returns
        -------
        lines : `~matplotlib2.collections.LineCollection`

        Other Parameters
        ----------------
        **kwargs :  `~matplotlib2.collections.LineCollection` properties.
    ...
    def eventplot(self, positions, orientation='horizontal', lineoffsets=1,
        ...
        **kwargs : optional
            ...
            :class:`~matplotlib2.collections.LineCollection` for a list of
    ...
    # ### Basic plotting
    # The label_naming happens in `matplotlib2.axes._base._plot_args`
    ...
    def plot(self, *args, **kwargs):
        ...
        **Colors**
        ...
        additionally use any  `matplotlib2.colors` spec, e.g. full names
    ...
    def plot_date(self, x, y, fmt='o', tz=None, xdate=True, ydate=False,
        ...
        x, y : array-like
            ...
            *True*, the respective values *x* or *y* are interpreted as
            :ref:`matplotlib2 dates <date-format>`.
        ...
        xdate : bool, optional, default: True
            If *True*, the *x*-axis will be interpreted as matplotlib2 dates.

        ydate : bool, optional, default: False
            If *True*, the *y*-axis will be interpreted as matplotlib2 dates.
        ...
        ----------------
        **kwargs
            Keyword arguments control the :class:`~matplotlib2.lines.Line2D`
            properties:
        ...
        See Also
        --------
        matplotlib2.dates : Helper functions on dates.
        matplotlib2.dates.date2num : Convert dates to num.
        matplotlib2.dates.num2date : Convert num to dates.
        matplotlib2.dates.drange : Create an equally spaced sequence of dates.
    ...
    def acorr(self, x, **kwargs):
        ...
        Other Parameters
        ----------------
        linestyle : `~matplotlib2.lines.Line2D` prop, optional, default: None
    ...
    def xcorr(self, x, y, normed=True, detrend=mlab.detrend_none,
        ...
        Other Parameters
        ----------------
        linestyle : `~matplotlib2.lines.Line2D` property, optional
            Only used if usevlines is ``False``.
        ...
        *xerr*, and *yerr* can be either scalars or sequences of
        ...
        if dp:
            warnings.warn(
                ...
                "Support for *left* will be removed in matplotlib2 3.0",
        ...
        *xerr*, and *yerr* can be either scalars or sequences of
        ...
        if dp:
            warnings.warn(
                ...
                "Support for *bottom* will be removed in matplotlib2 3.0",
                mplDeprecation, stacklevel=2)
    ...
    def stem(self, *args, **kwargs):
        ...
        **kwargs
        ...
        Returns
        -------
        container : :class:`~matplotlib2.container.StemContainer`
    ...
    def pie(self, x, explode=None, labels=None, colors=None,
        ...
        colors : array-like, optional, default: None
            A sequence of matplotlib2 color args through which the pie chart
        ...
        -------
        patches : list
            A sequence of :class:`matplotlib2.patches.Wedge` instances

        texts : list
            A list of the label :class:`matplotlib2.text.Text` instances.

        autotexts : list
            A list of :class:`~matplotlib2.text.Text` instances for the numeric
    ...
    def errorbar(self, x, y, yerr=None, xerr=None,
        ...
        *x*, *y* define the data locations, *xerr*, *yerr* define the errorbar
        ...
        ecolor : mpl color, optional, default: None
            A matplotlib2 color arg which gives the color the errorbar lines.
        ...
        container : :class:`~.container.ErrorbarContainer`
            ...
            - plotline: :class:`~matplotlib2.lines.Line2D` instance of
              x, y plot markers and/or line.
            - caplines: A tuple of :class:`~matplotlib2.lines.Line2D` instances
              of the error bar caps.
            - barlinecols: A tuple of
              :class:`~matplotlib2.collections.LineCollection` with the
    ...
    def boxplot(self, x, notch=None, sym=None, vert=None, whis=None,
        ...
        usermedians : array-like, optional
            ...
            by matplotlib2 for each element of ``usermedians`` that is not
            `None`. When an element of ``usermedians`` is None, the median
            will be computed by matplotlib2 as normal.

        conf_intervals : array-like, optional
            Array or sequence whose first dimension (or length) is
            compatible with ``x`` and whose second dimension is 2. When
            the an element of ``conf_intervals`` is not None, the
            notch locations computed by matplotlib2 are overridden
        ...
        result : dict
          ...
          of the :class:`matplotlib2.lines.Line2D` instances
        ...
        # If defined in matplotlib2rc, apply the value from rc file
    ...
    def bxp(self, bxpstats, positions=None, widths=None, vert=True,
        ...
        patch_artist : bool, default = False
          ...
          `~matplotlib2.lines.Line2D` artist.  If `True` produces boxes
          with the `~matplotlib2.patches.Patch` artist.
    ...
    def scatter(self, x, y, s=None, c=None, marker=None, cmap=None, norm=None,
        ...
        marker : `~matplotlib2.markers.MarkerStyle`, optional, default: 'o'
            The marker style. *marker* can be either an instance of the class
            or the text shorthand for a particular marker.
            See `~matplotlib2.markers` for more information marker styles.

        cmap : `~matplotlib2.colors.Colormap`, optional, default: None
            A `.Colormap` instance or registered colormap name. *cmap* is only
            used if *c* is an array of floats. If ``None``, defaults to rc
            ``image.cmap``.

        norm : `~matplotlib2.colors.Normalize`, optional, default: None
        ...
        Returns
        -------
        paths : `~matplotlib2.collections.PathCollection`

        Other Parameters
        ----------------
        **kwargs : `~matplotlib2.collections.Collection` properties
    ...
    def hexbin(self, x, y, C=None, gridsize=100, bins=None,
        ...
        *y* are 1-D sequences of the same length, *N*. If *C* is *None*
        ...
        cmap : object, optional, default is *None*
            a :class:`matplotlib2.colors.Colormap` instance. If *None*,
            defaults to rc ``image.cmap``.

        norm : object, optional, default is *None*
            :class:`matplotlib2.colors.Normalize` instance is used to
        ...
        edgecolors : {'face', 'none', *None*} or color, optional
            ...
            If a matplotlib2 color arg, draws outlines in the specified color.

        Returns
        -------
        object
            a :class:`~matplotlib2.collections.PolyCollection` instance; use
            :meth:`~matplotlib2.collections.PolyCollection.get_array` on
            this :class:`~matplotlib2.collections.PolyCollection` to get
        ...
        :class:`~matplotlib2.collections.Collection` parameters:
    ...
    def fill(self, *args, **kwargs):
        ...
        args : sequence of x, y, [color]
            ...
            :mod:`matplotlib2.colors` for supported color specifiers. The
        ...
        Returns
        -------
        a list of :class:`~matplotlib2.patches.Polygon`

        Other Parameters
        ----------------
        **kwargs : :class:`~matplotlib2.patches.Polygon` properties
    ...
    def imshow(self, X, cmap=None, norm=None, aspect=None,
        ...
        norm : `~matplotlib2.colors.Normalize`, optional, default: None
            A `~matplotlib2.colors.Normalize` instance is used to scale
            a 2-D float `X` input to the (0, 1) range for input to the
            `cmap`. If `norm` is None, use the default func:`normalize`.
            If `norm` is an instance of `~matplotlib2.colors.NoNorm`,
        ...
        Returns
        -------
        image : `~matplotlib2.image.AxesImage`

        Other Parameters
        ----------------
        **kwargs : `~matplotlib2.artist.Artist` properties.
        ...
        `~matplotlib2.pyplot.imshow` expects RGB images adopting the straight
    ...
    def pcolor(self, *args, **kwargs):
        ...
        *X* and *Y* can be used to specify the corners of the quadrilaterals.
        ...
        cmap : str or `~matplotlib2.colors.Colormap`, optional
            A Colormap instance or registered colormap name. The colormap
            maps the *C* values to colors. Defaults to :rc:`image.cmap`.

        norm : `~matplotlib2.colors.Normalize`, optional
        ...
        Returns
        -------
        collection : `matplotlib2.collections.Collection`
        ...
        **kwargs :
            ...
            along to the `~matplotlib2.collections.PolyCollection` constructor:
    ...
    def pcolormesh(self, *args, **kwargs):
        ...
        *X* and *Y* can be used to specify the corners of the quadrilaterals.
        ...
        Returns
        -------
        mesh : `matplotlib2.collections.QuadMesh`

        Other Parameters
        ----------------
        **kwargs
            Additionally, the following arguments are allowed. They are passed
            along to the `~matplotlib2.collections.QuadMesh` constructor:
    ...
    def table(self, **kwargs):
        ...
        Returns a :class:`matplotlib2.table.Table` instance. Either `cellText`
        or `cellColours` must be provided. For finer grained control over
        tables, use the :class:`~matplotlib2.table.Table` class and add it to
        the axes with :meth:`~matplotlib2.axes.Axes.add_table`.

        Thanks to John Gill for providing the class and table.

        kwargs control the :class:`~matplotlib2.table.Table`
        properties:
    ...
    def hist(self, x, bins=None, range=None, density=None, weights=None,
        ...
        orientation : {'horizontal', 'vertical'}, optional
            If 'horizontal', `~matplotlib2.pyplot.barh` will be used for
        ...
        Other Parameters
        ----------------
        **kwargs : `~matplotlib2.patches.Patch` properties
    ...
    def psd(self, x, NFFT=None, Fs=None, Fc=None, detrend=None,
        ...
        line : a :class:`~matplotlib2.lines.Line2D` instance
    ...
    def specgram(self, x, NFFT=None, Fs=None, Fc=None, detrend=None,
        ...
        *NFFT* length segments and the spectrum of each section is
        ...
        cmap :
            A :class:`matplotlib2.colors.Colormap` instance; if *None*, use
        ...
        **kwargs :
        ...
        im : instance of class :class:`~matplotlib2.image.AxesImage`
    ...
    def spy(self, Z, precision=0, marker=None, markersize=None,
        ...
        :func:`~matplotlib2.pyplot.imshow`; else, a
        :class:`~matplotlib2.lines.Line2D` object will be returned with
        the value of marker determining the marker type, and any
        remaining kwargs passed to the
        :meth:`~matplotlib2.axes.Axes.plot` method.
    ...
    def matshow(self, Z, **kwargs):
        ...
        Other Parameters
        ----------------
        **kwargs : `~matplotlib2.axes.Axes.imshow` arguments
        ...
        result : dict
          ...
          dictionary has the following keys:
            ...
            - ``bodies``: A list of the
              :class:`matplotlib2.collections.PolyCollection` instances
              containing the filled area of each violin.

            - ``cmeans``: A
              :class:`matplotlib2.collections.LineCollection` instance
