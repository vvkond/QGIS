...
from matplotlib2 import cbook, docstring, rcParams
from matplotlib2.ticker import (
    NullFormatter, ScalarFormatter, LogFormatterSciNotation, LogitFormatter,
    NullLocator, LogLocator, AutoLocator, AutoMinorLocator,
    SymmetricalLogLocator, LogitLocator)
from matplotlib2.transforms import Transform, IdentityTransform
...
class ScaleBase(object):
    ...
    def get_transform(self):
        """
        Return the :class:`~matplotlib2.transforms.Transform` object
    ...
    def set_default_locators_and_formatters(self, axis):
        """
        Set the :class:`~matplotlib2.ticker.Locator` and
        :class:`~matplotlib2.ticker.Formatter` objects on the given
...
class LinearScale(ScaleBase):
    ...
    def get_transform(self):
        ...
        :class:`~matplotlib2.transforms.IdentityTransform`.
        """
...
class LogScale(ScaleBase):
    ...
    def get_transform(self):
        """
        Return a :class:`~matplotlib2.transforms.Transform` instance
