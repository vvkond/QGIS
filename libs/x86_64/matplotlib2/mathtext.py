r"""
:mod:`~matplotlib2.mathtext` is a module for parsing a subset of the
TeX math syntax and drawing them to a matplotlib2 backend.
...
from matplotlib2 import _png, colors as mcolors, get_data_path, rcParams
from matplotlib2.afm import AFM
from matplotlib2.cbook import Bunch, get_realpath_and_stat, maxdict
from matplotlib2.ft2font import FT2Image, KERNING_DEFAULT, LOAD_NO_HINTING
from matplotlib2.font_manager import findfont, FontProperties, get_font
from matplotlib2._mathtext_data import (latex_to_bakoma, latex_to_standard,
...
class MathtextBackend(object):
    ...
    between mathtext and a specific matplotlib2 graphics backend.
...
class MathtextBackendAgg(MathtextBackend):
    ...
    def get_hinting_type(self):
        from matplotlib2.backends import backend_agg
...
class Fonts(object):
    ...
    def __init__(self, default_font_prop, mathtext_backend):
        """
        *default_font_prop*: A
        :class:`~matplotlib2.font_manager.FontProperties` object to use
...
class MathTextParser(object):
    ...
    def to_rgba(self, texstr, color='black', dpi=120, fontsize=14):
        ...
        *color*
            Any matplotlib2 color argument
    ...
    def to_png(self, filename, texstr, color='black', dpi=120, fontsize=14):
        ...
        *color*
            A valid matplotlib2 color argument
...
def math_to_image(s, filename_or_obj, prop=None, dpi=None, format=None):
    ...
    *format*
    ...
    """
    from matplotlib2 import figure
