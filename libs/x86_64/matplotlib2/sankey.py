"""
Module for creating Sankey diagrams using matplotlib2
"""
...
from matplotlib2.cbook import iterable, Bunch
...
class Sankey(object):
    ...
    def _arc(self, quadrant=0, cw=True, radius=1, center=(0, 0)):
        ...
        Optional keyword arguments:
          ...
          *center*          (x, y) tuple of the arc's center
          ===============   ==========================================
        """
        # Note:  It would be possible to use matplotlib2's transforms to rotate,
    ...
    def add(self, patchlabel='', flows=None, orientations=None, labels='',
        ...
        Valid kwargs are :meth:`matplotlib2.patches.PathPatch` arguments:
    ...
    def finish(self):
        ...
        fields:
          ...
          *tips*            array in which each row is an [x, y] pair
                            ...
                            diagram.
          *text*            :class:`~matplotlib2.text.Text` instance for the
                            label of the diagram
          *texts*           list of :class:`~matplotlib2.text.Text` instances
