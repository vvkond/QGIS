...
import matplotlib2.units as munits
import numpy as np
import warnings
...
class Axis(artist.Artist):
    ...
    * :attr:`labelpad` - number of points between the axis and its label
    ...
    def set_tick_params(self, which='major', reset=False, **kw):
        ...
        :meth:`matplotlib2.axes.Axes.tick_params`.
        """
        dicts = []
    ...
    def get_ticklabels(self, minor=False, which=None):
        """
        Get the tick labels as a list of :class:`~matplotlib2.text.Text`
        instances.
    ...
    def set_major_formatter(self, formatter):
        ...
        ACCEPTS: A :class:`~matplotlib2.ticker.Formatter` instance
        """
    ...
    def set_major_locator(self, locator):
        ...
        ACCEPTS: a :class:`~matplotlib2.ticker.Locator` instance
        """
...
class XAxis(Axis):
    ...
    def set_view_interval(self, vmin, vmax, ignore=False):
        ...
        :meth:`~matplotlib2.axes.Axes.set_xlim`.
...
class YAxis(Axis):
    ...
    def set_view_interval(self, vmin, vmax, ignore=False):
        ...
        expanded, but will not be reduced.  This method is
        for mpl internal use; for normal use, see
        :meth:`~matplotlib2.axes.Axes.set_ylim`.
