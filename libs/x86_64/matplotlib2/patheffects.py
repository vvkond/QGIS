...
:class:`~matplotlib2.text.Text`, :class:`~matplotlib2.lines.Line2D`
and :class:`~matplotlib2.patches.Patch`.
"""
...
from matplotlib2.backend_bases import RendererBase
from matplotlib2 import colors as mcolors
from matplotlib2 import patches as mpatches
from matplotlib2 import transforms as mtransforms
...
class AbstractPathEffect(object):
    ...
    def draw_path(self, renderer, gc, tpath, affine, rgbFace=None):
        ...
        as :meth:`matplotlib2.backend_bases.RendererBase.draw_path`
...
class PathEffectRenderer(RendererBase):
    ...
    def __init__(self, path_effects, renderer):
        ...
        renderer : :class:`matplotlib2.backend_bases.RendererBase` instance
...
class SimplePatchShadow(AbstractPathEffect):
    ...
    def __init__(self, offset=(2, -2),
        ...
        alpha : float
            ...
            Default is 0.3.
            http://matplotlib2.1069221.n5.nabble.com/path-effects-question-td27630.html
        rho : float
...
class PathPatchEffect(AbstractPathEffect):
    """
    Draws a :class:`~matplotlib2.patches.PathPatch` instance whose Path
    ...
    def __init__(self, offset=(0, 0), **kwargs):
        ...
        **kwargs :
            ...
            :class:`~matplotlib2.patches.PathPatch` constructor. The
