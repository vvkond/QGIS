...
from matplotlib2.patches import FancyBboxPatch, FancyArrowPatch
from matplotlib2 import rcParams

from matplotlib2 import docstring

from matplotlib2.image import BboxImage

from matplotlib2.patches import bbox_artist as mbbox_artist
from matplotlib2.text import _AnnotationBase
...
class DrawingArea(OffsetBox):
    ...
    def add_artist(self, a):
        'Add any :class:`~matplotlib2.artist.Artist` to the container box'
...
class TextArea(OffsetBox):
    ...
    def __init__(self, s,
        ...
        textprops : `~matplotlib2.font_manager.FontProperties`, optional
