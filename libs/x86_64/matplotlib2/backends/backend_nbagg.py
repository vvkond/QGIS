...
# lib/matplotlib2/backends/web_backend/nbagg_uat.ipynb to help verify
...
from matplotlib2 import rcParams, is_interactive
...
from matplotlib2.backends.backend_webagg_core import (
...
class CommSocket(object):
    ...
    def __init__(self, manager):
        ...
        try:
            self.comm = Comm('matplotlib2', data={'id': self.uuid})
