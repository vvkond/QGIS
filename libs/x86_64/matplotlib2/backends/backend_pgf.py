...
if sys.platform.startswith('win'):
    from matplotlib2 import font_manager
...
def common_texification(text):
    ...
    # Sometimes, matplotlib2 adds the unknown command \mathdefault.
...
class LatexManager(object):
    ...
    def get_width_height_descent(self, text, prop):
        ...
        # the height matplotlib2 expects goes from bottom to top.
...
class RendererPgf(RendererBase):
    ...
    def __init__(self, figure, fh, dummy=False):
        ...
        figure : `matplotlib2.figure.Figure`
            matplotlib2 figure to initialize height, width and dpi from.
        fh : file-like
    ...
    def draw_text(self, gc, x, y, s, prop, angle, ismath=False, mtext=None):
        ...
        if mtext and (
            ...
            # if not, use the text layout provided by matplotlib2
            text_args.append("x=%fin" % (x * f))
            text_args.append("y=%fin" % (y * f))
...
class FigureCanvasPgf(FigureCanvasBase):
    ...
    def _print_pgf_to_fh(self, fh, *args, **kwargs):
        ...
        header_text = """%% Creator: matplotlib2, PGF backend
%%
...
"""
        ...
        header_info_preamble = ["%% matplotlib2 used the following preamble"]
