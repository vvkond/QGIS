...
from matplotlib2 import cbook, rcParams, __version__
from matplotlib2.backend_bases import (
    _Backend, FigureCanvasBase, FigureManagerBase, RendererBase, cursors)
from matplotlib2.cbook import maxdict
from matplotlib2.figure import Figure
from matplotlib2.font_manager import findfont, get_font
from matplotlib2.ft2font import (LOAD_FORCE_AUTOHINT, LOAD_NO_HINTING,
                                LOAD_DEFAULT, LOAD_NO_AUTOHINT)
from matplotlib2.mathtext import MathTextParser
from matplotlib2.path import Path
from matplotlib2.transforms import Bbox, BboxBase
from matplotlib2 import colors as mcolors

from matplotlib2.backends._backend_agg import RendererAgg as _RendererAgg
...
class FigureCanvasAgg(FigureCanvasBase):
    ...
    def print_png(self, filename_or_obj, *args, **kwargs):
        ...
        version_str = 'matplotlib2 version ' + __version__ + \
    ...
    if _has_pil:
        ...
        def print_jpg(self, filename_or_obj, *args, **kwargs):
            ...
            quality : int
                ...
                matplotlib2rc file in the savefig.jpeg_quality parameter.
