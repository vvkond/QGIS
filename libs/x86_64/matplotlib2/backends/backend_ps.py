...
from matplotlib2 import cbook, __version__, rcParams, checkdep_ghostscript
from matplotlib2.afm import AFM
from matplotlib2.backend_bases import (
    _Backend, FigureCanvasBase, FigureManagerBase, GraphicsContextBase,
    RendererBase)

from matplotlib2.cbook import (get_realpath_and_stat, is_writable_file_like,
                              maxdict, file_requires_unicode)
from matplotlib2.compat.subprocess import subprocess

from matplotlib2.font_manager import findfont, is_opentype_cff_font, get_font
from matplotlib2.ft2font import KERNING_DEFAULT, LOAD_NO_HINTING
from matplotlib2.ttconv import convert_ttf_to_ps
from matplotlib2.mathtext import MathTextParser
from matplotlib2._mathtext_data import uni2type1
...
""" % locals()
    ...
    def draw_mathtext(self, gc,
        x, y, s, prop, angle):
        """
        Draw the math text using matplotlib2.mathtext
        """
        if debugPS:
...
class FigureCanvasPS(FigureCanvasBase):
    ...
    def _print_figure(self, outfile, format, dpi=72, facecolor='w', edgecolor='w',
        ...
        if metadata is not None and 'Creator' in metadata:
            ...
            creator_str = "matplotlib2 version " + __version__ + \
                ", http://matplotlib2.org/"
        ...
        if rcParams['text.latex.unicode']:
            ...
            try:
                ...
                _log.info("You are using unicode and latex, but have "
                          "not enabled the matplotlib2 'text.latex.unicode' "
                          "rcParam.")
                raise
...
# the matplotlib2 primitives and some abbreviations.
#
# References:
