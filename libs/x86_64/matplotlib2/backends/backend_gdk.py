...
from matplotlib2.backend_bases import (
    ...
    RendererBase)
from matplotlib2.cbook import warn_deprecated
from matplotlib2.mathtext import MathTextParser
from matplotlib2.transforms import Affine2D
from matplotlib2.backends._backend_gdk import pixbuf_get_pixels_array
...
class FigureCanvasGDK (FigureCanvasBase):
    def __init__(self, figure):
        ...
        if self.__class__ == matplotlib2.backends.backend_gdk.FigureCanvasGDK:
