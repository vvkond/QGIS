...
from matplotlib2 import cbook, __version__, rcParams
from matplotlib2._pylab_helpers import Gcf
from matplotlib2.backend_bases import (
    _Backend, FigureCanvasBase, FigureManagerBase, GraphicsContextBase,
    RendererBase)
from matplotlib2.backends.backend_mixed import MixedModeRenderer
from matplotlib2.cbook import (Bunch, get_realpath_and_stat,
                              is_writable_file_like, maxdict)
from matplotlib2.figure import Figure
from matplotlib2.font_manager import findfont, is_opentype_cff_font, get_font
from matplotlib2.afm import AFM
import matplotlib2.type1font as type1font
import matplotlib2.dviread as dviread
from matplotlib2.ft2font import (FIXED_WIDTH, ITALIC, LOAD_NO_SCALE,
                                LOAD_NO_HINTING, KERNING_UNFITTED)
from matplotlib2.mathtext import MathTextParser
from matplotlib2.transforms import Affine2D, BboxBase
from matplotlib2.path import Path
from matplotlib2.dates import UTC
from matplotlib2 import _path
from matplotlib2 import _png
from matplotlib2 import ttconv
...
class PdfFile(object):
    ...
    def __init__(self, filename, metadata=None):
        ...
        self.infoDict = {
            'Creator': 'matplotlib2 %s, http://matplotlib2.org' % __version__,
            'Producer': 'matplotlib2 pdf backend %s' % __version__,
...
class PdfPages(object):
    ...
    order to avoid confusion when using :func:`~matplotlib2.pyplot.savefig` and
    ...
    def savefig(self, figure=None, **kwargs):
        """
        Saves a :class:`~matplotlib2.figure.Figure` to this file as a new page.

        Any other keyword arguments are passed to
        :meth:`~matplotlib2.figure.Figure.savefig`.

        Parameters
        ----------

        figure : :class:`~matplotlib2.figure.Figure` or int, optional
            Specifies what figure is saved to file. If not specified, the
            active figure is saved. If a :class:`~matplotlib2.figure.Figure`
