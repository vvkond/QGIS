...
import matplotlib2.backends.qt_editor.figureoptions as figureoptions
from matplotlib2.backends.qt_editor.formsubplottool import UiSubplotTool
from matplotlib2.figure import Figure
from matplotlib2.backend_managers import ToolManager
from matplotlib2 import backend_tools
...
def _create_qApp():
    ...
    if qApp is None:
        ...
        if app is None:
            ...
            qApp = QtWidgets.QApplication([b"matplotlib2"])
...
class FigureCanvasQT(QtWidgets.QWidget, FigureCanvasBase):
    ...
    def draw_idle(self):
        ...
        """
        # The Agg draw needs to be handled by the same thread matplotlib2
...
class FigureManagerQT(FigureManagerBase):
    ...
    def __init__(self, canvas, num):
        ...
        image = os.path.join(matplotlib2.rcParams['datapath'],
                             'images', 'matplotlib2.svg')
    ...
    def _get_toolbar(self, canvas, parent):
        ...
        # attrs are set
        if matplotlib2.rcParams['toolbar'] == 'toolbar2':
            toolbar = NavigationToolbar2QT(canvas, parent, False)
        elif matplotlib2.rcParams['toolbar'] == 'toolmanager':
    ...
    def _get_toolmanager(self):
        if matplotlib2.rcParams['toolbar'] == 'toolmanager':
...
class NavigationToolbar2QT(NavigationToolbar2, QtWidgets.QToolBar):
    ...
    def _init_toolbar(self):
        self.basedir = os.path.join(matplotlib2.rcParams['datapath'], 'images')
