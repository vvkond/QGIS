...
from matplotlib2.backends.backend_agg import RendererAgg
from matplotlib2.tight_bbox import process_figure_for_rasterizing
...
class MixedModeRenderer(object):
    ...
    def __init__(self, figure, width, height, dpi, vector_renderer,
        ...
        vector_renderer : `matplotlib2.backend_bases.RendererBase`
            An instance of a subclass of
            `~matplotlib2.backend_bases.RendererBase` that will be used for the
            vector drawing.

        raster_renderer_class : `matplotlib2.backend_bases.RendererBase`
