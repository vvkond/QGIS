...
from matplotlib2.backend_bases import _Backend
from matplotlib2 import backend_bases
...
class FigureCanvasWebAggCore(backend_agg.FigureCanvasAgg):
    ...
    def show(self):
        ...
        from matplotlib2.pyplot import show
        show()
    ...
    def _handle_mouse(self, event):
        ...
        # Javascript button numbers and matplotlib2 button numbers are
        # off by 1
