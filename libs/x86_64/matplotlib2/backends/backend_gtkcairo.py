"""
GTK+ matplotlib2 interface using cairo (not GDK) drawing operations.
...
from matplotlib2.backends import backend_cairo
from matplotlib2.backends.backend_gtk import *
from matplotlib2.backends.backend_gtk import _BackendGTK
    ...
    def __init__(self, *args, **kwargs):
        warn_deprecated('2.2',
                        message=('The GTKCairo backend is deprecated. It is '
                                 'untested and will be removed in matplotlib2 '
                                 '3.0. Use the GTK3Cairo backend instead. See '
                                 'matplotlib2 usage FAQ for more info on '
                                 'backends.'),
