...
import matplotlib2.style
import matplotlib2.units
import matplotlib2.testing
from matplotlib2 import cbook
from matplotlib2 import ticker
from matplotlib2 import pyplot as plt
from matplotlib2 import ft2font
from matplotlib2.testing.compare import (
...
def _do_cleanup(original_units_registry, original_settings):
    ...
    matplotlib2.units.registry.clear()
    matplotlib2.units.registry.update(original_units_registry)
...
class CleanupTest(object):
    @classmethod
    def setup_class(cls):
        cls.original_units_registry = matplotlib2.units.registry.copy()
...
class ImageComparisonTest(CleanupTest, _ImageComparisonBase):
    ...
    def setup(self):
        ...
        self.setup_class()
        try:
            matplotlib2.style.use(self.style)
            matplotlib2.testing.set_font_settings_for_testing()
            func()
...
def image_comparison(baseline_images, extensions=None, tol=0,
    ...
    *baseline_images*, which must correspond else an
    ...
    baseline_images : list or None
        ...
        calls to :meth:`matplotlib2.figure.savefig`.
...
def _image_directories(func):
    ...
    if module_name == '__main__':
        # FIXME: this won't work for nested packages in matplotlib2.tests
        warnings.warn(
        ...
        if len(mods) >= 3:
            ...
            # most cases "matplotlib2") However if this is a
            # namespace package pip installed and run via the nose
            # multiprocess plugin or as a specific test this may be
            # missing. See https://github.com/matplotlib2/matplotlib2/issues/3314
        if mods.pop(0) != 'tests':
            warnings.warn(
...
def skip_if_command_unavailable(cmd):
    ...
    cmd : list of str
        ...
        ["latex", "-version"]
    """
    from matplotlib2.compat.subprocess import check_output
    try:
        check_output(cmd)
    except:
        import pytest
