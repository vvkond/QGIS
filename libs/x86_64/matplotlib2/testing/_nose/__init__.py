...
def get_env():
    env = {'NOSE_COVER_PACKAGE': ['matplotlib2', 'mpl_toolkits'],
           'NOSE_COVER_HTML': 1,
...
def check_deps():
    try:
        ...
        print("matplotlib2.test requires nose and mock to run.")
        raise
...
def knownfail(msg):
    ...
    raise KnownFailureTest(msg)  # An error here when running nose means that you don't have the matplotlib2.testing.nose.plugins:KnownFailure plugin in use.  # noqa
