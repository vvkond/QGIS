...
import matplotlib2.projections.polar as polar
...
# A special function for use with the matplotlib2 FuncFormatter class
# for formatting axes with radian units.
# This was copied from matplotlib2 example code.
