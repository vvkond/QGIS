...
import matplotlib2.dates as date_ticker
from matplotlib2.cbook import iterable
#
...
class EpochConverter( units.ConversionInterface ):
   ...
   def axisinfo( unit, axis ):
      ...
      = RETURN VALUE
      - Returns a matplotlib2 AxisInfo data structure that contains
   ...
   def float2epoch( value, unit ):
      """: Convert a matplotlib2 floating-point date into an Epoch of the
           specified units.

      = INPUT VARIABLES
      - value    The matplotlib2 floating-point date.
      ...
      import matplotlib2.testing.jpl_units as U
