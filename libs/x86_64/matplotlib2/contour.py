...
import matplotlib2._contour as _contour
...
import matplotlib2.text as text
import matplotlib2.cbook as cbook
import matplotlib2.mathtext as mathtext
import matplotlib2.patches as mpatches
import matplotlib2.texmanager as texmanager
import matplotlib2.transforms as mtransforms

# Import needed for adding manual selection capability to clabel
from matplotlib2.blocking_input import BlockingContourLabeler
...
class ContourLabeler(object):
    ...
    def clabel(self, *args, **kwargs):
        ...
        :class:`~matplotlib2.contour.ContourSet` object returned by
        contour.
        ...
        colors :
            ...
            - if a tuple of matplotlib2 color args (string, float, rgb, etc),
        ...
        fmt : string or dict, optional
            ...
            as a :class:`~matplotlib2.ticker.Formatter` instance, that
    ...
    def add_label(self, x, y, rotation, lev, cvalue):
        """
        Add contour label using :class:`~matplotlib2.text.Text` class.
        """
...
class ContourSet(cm.ScalarMappable, ContourLabeler):
    ...
    def get_transform(self):
        """
        Return the :class:`~matplotlib2.transforms.Transform`
...
class QuadContourSet(ContourSet):
    ...
    _contour_doc = """
        ...
        :func:`~matplotlib2.pyplot.contour` and
        :func:`~matplotlib2.pyplot.contourf` draw contour lines and
        ...
        Returns
        -------
        :class:`~matplotlib2.contour.QuadContourSet`
        ...
        extent : (x0, x1, y0, y1), optional
            ...
            in :func:`matplotlib2.pyplot.imshow`: it gives the outer
        ...
        extend : {'neither', 'both', 'min', 'max'}, optional
            ...
            :meth:`matplotlib2.colors.Colormap.set_under` and
            :meth:`matplotlib2.colors.Colormap.set_over` methods.

        xunits, yunits : registered units, optional
            Override axis units by specifying an instance of a
            :class:`matplotlib2.units.ConversionInterface`.
        ...
        Notes
        -----
        1. :func:`~matplotlib2.pyplot.contourf` differs from the MATLAB
           version in that it does not draw the polygon edges.
           To draw edges, add line contours with
           calls to :func:`~matplotlib2.pyplot.contour`.
