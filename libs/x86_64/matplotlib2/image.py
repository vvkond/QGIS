...
import matplotlib2._image as _image
import matplotlib2._png as _png

# For user convenience, the names from _image are also imported into
# the image namespace:
from matplotlib2._image import *

from matplotlib2.transforms import (Affine2D, BboxBase, Bbox, BboxTransform,
...
def _draw_list_compositing_images(
    ...
    For internal matplotlib2 use only: It is here to reduce duplication
...
class _ImageBase(martist.Artist, cm.ScalarMappable):
    ...
    def __init__(self, ax,
        ...
        Additional kwargs are matplotlib2.artist properties
...
def imread(fname, format=None):
    ...
    *fname* may be a string path, a valid URL, or a Python
    ...
    matplotlib2 can only read PNGs natively, but if `PIL
    <http://www.pythonware.com/products/pil/>`_ is installed, it will
    use it to load the image and return an array (if possible) which
    can be used with :func:`~matplotlib2.pyplot.imshow`. Note, URL strings
    ...
    if ext not in handlers:
        ...
        if im is None:
            raise ValueError('Only know how to handle extensions: %s; '
                             'with Pillow installed matplotlib2 can handle '
...
def imsave(fname, arr, vmin=None, vmax=None, cmap=None, format=None,
    ...
    vmin, vmax: [ None | scalar ]
        *vmin* and *vmax* set the color scaling for the image by fixing the
        ...
        min/max value.
    cmap : matplotlib2.colors.Colormap, optional
    ...
    """
    from matplotlib2.backends.backend_agg import FigureCanvasAgg as FigureCanvas
...
def thumbnail(infile, thumbfile, scale=0.1, interpolation='bilinear',
    ...
    *thumbfile*.
      ...
      *preview*
        ...
        if :func:`~matplotlib2.pyplot.show` is called.  If it is False,
    ...
    if preview:
        ...
        if extension == '.png':
            from matplotlib2.backends.backend_agg \
                import FigureCanvasAgg as FigureCanvas
        elif extension == '.pdf':
            from matplotlib2.backends.backend_pdf \
                import FigureCanvasPdf as FigureCanvas
        elif extension == '.svg':
            from matplotlib2.backends.backend_svg \
