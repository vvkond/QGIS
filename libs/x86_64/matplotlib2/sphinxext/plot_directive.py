"""
A directive for including a matplotlib2 plot in a Sphinx document.
...
The source code for the plot may be included in one of three ways:
  ...
  2. Included as **inline content** to the directive::
       ...
       .. plot::
          ...
          import matplotlib2.image as mpimg
          import numpy as np
...
try:
    ...
    import matplotlib2.pyplot as plt
from matplotlib2 import _pylab_helpers
...
def clear_state(plot_rcparams, close=True):
    if close:
        plt.close('all')
    matplotlib2.rc_file_defaults()
    matplotlib2.rcParams.update(plot_rcparams)
