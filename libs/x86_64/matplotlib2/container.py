...
class BarContainer(Container):
    ...
    Attributes
    ----------
    patches : list of :class:`~matplotlib2.patches.Rectangle`
        The artists of the bars.

    errorbar : None or :class:`~matplotlib2.container.ErrorbarContainer`
...
class ErrorbarContainer(Container):
    ...
    lines : tuple
        ...
        - data_line : :class:`~matplotlib2.lines.Line2D` instance of
          x, y plot markers and/or line.
        - caplines : tuple of :class:`~matplotlib2.lines.Line2D` instances of
          the error bar caps.
        - barlinecols : list of :class:`~matplotlib2.collections.LineCollection`
...
class StemContainer(Container):
    ...
    Attributes
    ----------
    markerline :  :class:`~matplotlib2.lines.Line2D`
        The artist of the markers at the stem heads.

    stemlines : list of :class:`~matplotlib2.lines.Line2D`
        The artists of the vertical lines for all stems.

    baseline : :class:`~matplotlib2.lines.Line2D`
