...
from matplotlib2.tri import Triangulation
from matplotlib2.tri.trifinder import TriFinder
from matplotlib2.tri.tritools import TriAnalyzer
import numpy as np
import warnings
...
class LinearTriInterpolator(TriInterpolator):
    ...
    Parameters
    ----------
    triangulation : :class:`~matplotlib2.tri.Triangulation` object
        The triangulation to interpolate over.
    z : array_like of shape (npoints,)
        Array of values, defined at grid points, to interpolate between.
    trifinder : :class:`~matplotlib2.tri.TriFinder` object, optional
          If this is not specified, the Triangulation's default TriFinder will
          be used by calling
          :func:`matplotlib2.tri.Triangulation.get_trifinder`.
...
class CubicTriInterpolator(TriInterpolator):
    ...
    :class:`~matplotlib2.tri.CubicTriInterpolator` computes a cubic
    interpolation.
