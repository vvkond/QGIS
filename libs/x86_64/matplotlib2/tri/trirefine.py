...
import matplotlib2.tri.triinterpolate
    ...
    Derived classes must implements:
        ...
        - ``refine_field(z, triinterpolator=None, **kwargs)`` , where:
              ...
              - *triinterpolator* is a
                :class:`~matplotlib2.tri.TriInterpolator` (optional)
...
class UniformTriRefiner(TriRefiner):
    ...
    Parameters
    ----------
    triangulation : :class:`~matplotlib2.tri.Triangulation`
                     The encapsulated triangulation (to be refined)
    """
#    See Also
#    --------
#    :class:`~matplotlib2.tri.CubicTriInterpolator` and
#    :class:`~matplotlib2.tri.TriAnalyzer`.
#    """
    def __init__(self, triangulation):
    ...
    def refine_triangulation(self, return_tri_index=False, subdiv=3):
        ...
        Returns
        -------
        refi_triangulation : :class:`~matplotlib2.tri.Triangulation`
    ...
    def refine_field(self, z, triinterpolator=None, subdiv=3):
        ...
        triinterpolator : :class:`~matplotlib2.tri.TriInterpolator`, optional
            Interpolator used for field interpolation. If not specified,
            a :class:`~matplotlib2.tri.CubicTriInterpolator` will
            be used.
        subdiv : integer, optional
        ...
        Returns
        -------
        refi_tri : :class:`~matplotlib2.tri.Triangulation` object
                     The returned refined triangulation
        refi_z : 1d array of length: *refi_tri* node count.
                   The returned interpolated field (at *refi_tri* nodes)
        """
        if triinterpolator is None:
            interp = matplotlib2.tri.CubicTriInterpolator(
                self._triangulation, z)
        else:
            if not isinstance(triinterpolator,
                              matplotlib2.tri.TriInterpolator):
    ...
    def _refine_triangulation_once(triangulation, ancestors=None):
        """
        This function refines a matplotlib2.tri *triangulation* by splitting
