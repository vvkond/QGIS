...
import matplotlib2._qhull as _qhull
import numpy as np
...
class Triangulation(object):
    ...
    def __init__(self, x, y, triangles=None, mask=None):
        ...
        if triangles is None:
            # No triangulation specified, so use matplotlib2._qhull to obtain
    ...
    def get_trifinder(self):
        """
        Return the default :class:`matplotlib2.tri.TriFinder` of this
        triangulation, creating it if necessary.  This allows the same
        TriFinder object to be easily shared.
        """
        if self._trifinder is None:
            # Default TriFinder class.
            from matplotlib2.tri.trifinder import TrapezoidMapTriFinder
