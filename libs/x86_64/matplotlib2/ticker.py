...
example of setting major and minor ticks. See the :mod:`matplotlib2.dates`
...
from matplotlib2.cbook import mplDeprecation
    ...
    def format_eng(self, num):
        ...
        if isinstance(num, six.string_types):
            warnings.warn(
                ...
                "matplotlib2 2.1, and is expected to be removed in 2.3.",
                mplDeprecation)
...
class Locator(TickHelper):
    ...
    :class:`~matplotlib2.axis.Axis` because the locator stores references to
...
class AutoLocator(MaxNLocator):
    ...
    of `~matplotlib2.ticker.MaxNLocator`, with parameters *nbins = 'auto'*
    and *steps = [1, 2, 2.5, 5, 10]*.
    """
    def __init__(self):
        """
        To know the values of the non-public parameters, please have a
        look to the defaults of `~matplotlib2.ticker.MaxNLocator`.
        """
        if rcParams['_internal.classic_mode']:
            nbins = 9
            steps = [1, 2, 5, 10]
